...
class Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'HeimrichHannot\\UtilsBundle\\Util\\Utils' => 'getUtilsService',
            'Markocupic\\GalleryCreatorBundle\\EventSubscriber\\AddBackendAssetsSubscriber' => 'getAddBackendAssetsSubscriberService',
            'Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener' => 'getKernelRequestListenerService',
            'Oveleon\\ContaoCookiebar\\EventSubscriber\\KernelRequestSubscriber' => 'getKernelRequestSubscriberService',
            'assets.packages' => 'getAssets_PackagesService',
            'bugbuster.clienthintsrequest.kernelresponse_listener' => 'getBugbuster_Clienthintsrequest_KernelresponseListenerService',
            'bugbuster.dlstats.kernelresponse_listener' => 'getBugbuster_Dlstats_KernelresponseListenerService',
            ...
            'huh.ajax' => 'getHuh_AjaxService',
            'profiler' => 'getProfilerService',
        ];
        $this->fileMap = [
            'BugBuster\\DlstatsBundle\\Controller\\DlstatsController' => 'getDlstatsControllerService',
            'BugBuster\\DlstatsExportBundle\\Controller\\ExportController' => 'getExportControllerService',
            'BugBuster\\VisitorsBundle\\Classes\\VisitorCalculator' => 'getVisitorCalculatorService',
            'BugBuster\\VisitorsBundle\\Classes\\VisitorLogger' => 'getVisitorLoggerService',
            'BugBuster\\VisitorsBundle\\Controller\\FrontendModule\\VisitorsFrontendController' => 'getVisitorsFrontendControllerService',
            'BugBuster\\VisitorsBundle\\Controller\\VisitorsController' => 'getVisitorsControllerService',
            'BugBuster\\VisitorsBundle\\Controller\\VisitorsFeAjaxController' => 'getVisitorsFeAjaxControllerService',
            'BugBuster\\VisitorsBundle\\Controller\\VisitorsFeController' => 'getVisitorsFeControllerService',
            'Cgoit\\CalendarExtendedBundle\\EventListener\\DataContainer\\CalendarEventsCallbacks' => 'getCalendarEventsCallbacksService',
            'Cgoit\\CalendarExtendedBundle\\EventListener\\DataContainer\\ModuleCallbacks' => 'getModuleCallbacksService',
            'Cgoit\\CalendarExtendedBundle\\Hook\\GetAllEventsHook' => 'getGetAllEventsHookService',
            'Cgoit\\CalendarExtendedBundle\\Hook\\ParseFrontendTemplateHook' => 'getParseFrontendTemplateHookService',
            'Cgoit\\CmaceBundle\\EventListener\\DataContainer\\ContentCalendarOptionsListener' => 'getContentCalendarOptionsListenerService',
            'Cgoit\\CmaceBundle\\EventListener\\DataContainer\\ReaderModuleOptionsListener' => 'getReaderModuleOptionsListenerService',
            'Cgoit\\FormFillPdfBundle\\EventListener\\DataContainer\\FormFieldFpConfigsOptionsListener' => 'getFormFieldFpConfigsOptionsListenerService',
            'Cgoit\\FormFillPdfBundle\\EventListener\\DataContainer\\FormOnLoadEventListener' => 'getFormOnLoadEventListenerService',
            'Cgoit\\FormFillPdfBundle\\EventListener\\PrepareFormDataListener' => 'getPrepareFormDataListenerService',
            'Cgoit\\FormFillPdfBundle\\EventListener\\ProcessFormDataListener' => 'getProcessFormDataListenerService',
            'Cgoit\\LeadsOptinBundle\\Controller\\Module\\LeadsOptInModule' => 'getLeadsOptInModuleService',
            'Cgoit\\LeadsOptinBundle\\EventListener\\DataContainer\\Form' => 'getFormService',
            'Cgoit\\LeadsOptinBundle\\EventListener\\DataContainer\\Lead' => 'getLeadService',
            'Cgoit\\LeadsOptinBundle\\EventListener\\DataContainer\\Module' => 'getModuleService',
            'Cgoit\\LeadsOptinBundle\\Hook\\PrepareFormDataHook' => 'getPrepareFormDataHookService',
            'Cgoit\\LeadsOptinBundle\\Hook\\ProcessFormDataHook' => 'getProcessFormDataHookService',
            ...
            'Codefog\\NewsCategoriesBundle\\Criteria\\NewsCriteriaBuilder' => 'getNewsCriteriaBuilderService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\ChangeLanguageListener' => 'getChangeLanguageListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryPermissionListener' => 'getCategoryPermissionListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener' => 'getCategoryRootListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\ContentNewsModuleOptionsListener' => 'getContentNewsModuleOptionsListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\NewsArchiveOperationListener' => 'getNewsArchiveOperationListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\NewsCategoriesOptionsListener' => 'getNewsCategoriesOptionsListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\NewsCategoryAliasListener' => 'getNewsCategoryAliasListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\NewsDefaultCategoriesListener' => 'getNewsDefaultCategoriesListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\SettingSlugOptionsListener' => 'getSettingSlugOptionsListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\InsertTagsListener' => 'getInsertTagsListener2Service',
            'Codefog\\NewsCategoriesBundle\\EventListener\\NewsListener' => 'getNewsListenerService',
            'Codefog\\NewsCategoriesBundle\\EventListener\\TemplateListener' => 'getTemplateListenerService',
            'Codefog\\NewsCategoriesBundle\\NewsCategoriesManager' => 'getNewsCategoriesManagerService',
            'ContaoThemesNet\\MateThemeBundle\\EventListener\\HookListener' => 'getHookListenerService',
            ...
            'DanielGausi\\CalendarEditorBundle\\Services\\CheckAuthService' => 'getCheckAuthServiceService',
            'Diversworld\\ContaoCheckBundle\\Controller\\FrontendModule\\CheckListingController' => 'getCheckListingControllerService',
            'Diversworld\\ContaoCheckBundle\\Controller\\MyCustomController' => 'getMyCustomControllerService',
            'Diversworld\\ContaoCheckBundle\\DataContainer\\DwCheck' => 'getDwCheckService',
            'Diversworld\\ContaoDucappBundle\\Controller\\MyCustomController' => 'getMyCustomController2Service',
            'Diversworld\\ContaoDucappBundle\\DataContainer\\DucTanks' => 'getDucTanksService',
            'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController' => 'getProfilerControllerService',
            'HeimrichHannot\\AjaxBundle\\EventListener\\Contao\\InitializeSystemListener' => 'getInitializeSystemListenerService',
            'HeimrichHannot\\AjaxBundle\\Manager\\AjaxManager' => 'getAjaxManagerService',
            'HeimrichHannot\\MultiColumnEditorBundle\\Asset\\MceAssets' => 'getMceAssetsService',
            'HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\ExecutePostActionsListener' => 'getExecutePostActionsListenerService',
            'HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\InitializeSystemListener' => 'getInitializeSystemListener2Service',
            'HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\LoadDataContainerListener' => 'getLoadDataContainerListenerService',
            'HeimrichHannot\\UtilsBundle\\EventListener\\DcaField\\DateAddedFieldListener' => 'getDateAddedFieldListenerService',
            'HeimrichHannot\\UtilsBundle\\EventListener\\DcaField\\DcaAuthorListener' => 'getDcaAuthorListenerService',
            'InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener' => 'getParseWidgetListenerService',
            'InspiredMinds\\ContaoEventRegistration\\Controller\\EventRegistrationExportController' => 'getEventRegistrationExportControllerService',
            'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationCancelController' => 'getEventRegistrationCancelControllerService',
            'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationConfirmController' => 'getEventRegistrationConfirmControllerService',
            'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationFormController' => 'getEventRegistrationFormControllerService',
            'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationListController' => 'getEventRegistrationListControllerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\CalendarEvents\\ConfigOnLoadCallbackListener' => 'getConfigOnLoadCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\CalendarEvents\\RegistrationFormOptionsCallbackListener' => 'getRegistrationFormOptionsCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\CalendarEvents\\RegistrationsButtonCallbackListener' => 'getRegistrationsButtonCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\CalendarEvents\\WaitingListAdvancementNotificationOptionsCallbackListener' => 'getWaitingListAdvancementNotificationOptionsCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\ChildRecordCallbackListener' => 'getChildRecordCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\ConfigOnLoadCallbackListener' => 'getConfigOnLoadCallbackListener2Service',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\ConfigOnShowCallbackListener' => 'getConfigOnShowCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\ConfigOnSubmitCallbackListener' => 'getConfigOnSubmitCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\ExportButtonCallbackListener' => 'getExportButtonCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\FormDataLoadCallbackListener' => 'getFormDataLoadCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\EventRegistration\\HeaderCallbackListener' => 'getHeaderCallbackListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\DataContainer\\FrontendModule\\RegistrationStatusNotificationOptionsCallback' => 'getRegistrationStatusNotificationOptionsCallbackService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\EventParseTemplateListener' => 'getEventParseTemplateListenerService',
            'InspiredMinds\\ContaoEventRegistration\\EventListener\\EventRegistrationFormListener' => 'getEventRegistrationFormListenerService',
            'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\ResetVerifyController' => 'getResetVerifyControllerService',
            'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\SendEmailConfirmController' => 'getSendEmailConfirmControllerService',
            'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\UserIdentifierFormController' => 'getUserIdentifierFormControllerService',
            'Markocupic\\BackendPasswordRecoveryBundle\\EventListener\\Contao\\ParseTemplateListener' => 'getParseTemplateListenerService',
            'Markocupic\\ContaoAltchaAntispam\\Controller\\AltchaController' => 'getAltchaControllerService',
            'Markocupic\\ContaoAltchaAntispam\\DataContainer\\FormField' => 'getFormFieldService',
            'Markocupic\\ContaoAltchaAntispam\\EventListener\\ProcessFormDataListener' => 'getProcessFormDataListener2Service',
            'Markocupic\\ContaoAltchaAntispam\\Storage\\MpFormsManager' => 'getMpFormsManagerService',
            'Markocupic\\ContaoAltchaAntispam\\Validator\\AltchaValidator' => 'getAltchaValidatorService',
            'Markocupic\\ContaoBundleCreatorBundle\\DataContainer\\ContaoBundleCreator' => 'getContaoBundleCreatorService',
            'Markocupic\\ContaoBundleCreatorBundle\\EventListener\\ContaoHook\\AddCustomRegexpListener' => 'getAddCustomRegexpListenerService',
            'Markocupic\\GalleryCreatorBundle\\ContaoManager\\Plugin' => 'getPluginService',
            'Markocupic\\GalleryCreatorBundle\\Controller\\Ajax\\GalleryCreatorAjax' => 'getGalleryCreatorAjaxService',
            'Markocupic\\GalleryCreatorBundle\\Controller\\ContentElement\\DependencyAggregate' => 'getDependencyAggregateService',
            'Markocupic\\GalleryCreatorBundle\\Controller\\ContentElement\\GalleryCreatorController' => 'getGalleryCreatorControllerService',
            'Markocupic\\GalleryCreatorBundle\\Controller\\ContentElement\\GalleryCreatorNewsController' => 'getGalleryCreatorNewsControllerService',
            'Markocupic\\GalleryCreatorBundle\\DataContainer\\Content' => 'getContentService',
            'Markocupic\\GalleryCreatorBundle\\DataContainer\\GalleryCreatorAlbums' => 'getGalleryCreatorAlbumsService',
            'Markocupic\\GalleryCreatorBundle\\DataContainer\\GalleryCreatorPictures' => 'getGalleryCreatorPicturesService',
            'Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\GalleryCreatorFrontendTemplateListener' => 'getGalleryCreatorFrontendTemplateListenerService',
            'Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\GalleryCreatorImagePostInsertListener' => 'getGalleryCreatorImagePostInsertListenerService',
            'Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\InitializeSystemListener' => 'getInitializeSystemListener3Service',
            'Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\ParseBackendTemplate' => 'getParseBackendTemplateService',
            'Markocupic\\GalleryCreatorBundle\\MarkocupicGalleryCreatorBundle' => 'getMarkocupicGalleryCreatorBundleService',
            'Markocupic\\GalleryCreatorBundle\\Migration\\Version200\\AddDefaultChmodMigration' => 'getAddDefaultChmodMigrationService',
            'Markocupic\\GalleryCreatorBundle\\Migration\\Version200\\RenameColumnsMigration' => 'getRenameColumnsMigrationService',
            'Markocupic\\GalleryCreatorBundle\\Revise\\ReviseAlbumDatabase' => 'getReviseAlbumDatabaseService',
            'Markocupic\\GalleryCreatorBundle\\Security\\GalleryCreatorAlbumPermissions' => 'getGalleryCreatorAlbumPermissionsService',
            'Markocupic\\GalleryCreatorBundle\\Security\\Voter\\AlbumVoter' => 'getAlbumVoterService',
            'Markocupic\\GalleryCreatorBundle\\Util\\AlbumUtil' => 'getAlbumUtilService',
            'Markocupic\\GalleryCreatorBundle\\Util\\FileUtil' => 'getFileUtilService',
            'Markocupic\\GalleryCreatorBundle\\Util\\MarkdownUtil' => 'getMarkdownUtilService',
            'Markocupic\\GalleryCreatorBundle\\Util\\PictureUtil' => 'getPictureUtilService',
            'Markocupic\\GalleryCreatorBundle\\Util\\SecurityUtil' => 'getSecurityUtilService',
            'Markocupic\\GalleryCreatorBundle\\Widget\\Backend\\AlbumTreeWidget' => 'getAlbumTreeWidgetService',
            'Markocupic\\GalleryCreatorBundle\\Widget\\Backend\\ChmodTable' => 'getChmodTableService',
            'Markocupic\\ImportFromCsvBundle\\ContaoManager\\Plugin' => 'getPlugin2Service',
            'Markocupic\\ImportFromCsvBundle\\Contao\\Controller\\ImportAjaxController' => 'getImportAjaxControllerService',
            'Markocupic\\ImportFromCsvBundle\\Contao\\Controller\\MountAppAjaxController' => 'getMountAppAjaxControllerService',
            'Markocupic\\ImportFromCsvBundle\\Contao\\Controller\\RenderBackendAppController' => 'getRenderBackendAppControllerService',
            'Markocupic\\ImportFromCsvBundle\\Cron\\Cron' => 'getCronService',
            'Markocupic\\ImportFromCsvBundle\\DataContainer\\ImportFromCsv' => 'getImportFromCsvService',
            'Markocupic\\ImportFromCsvBundle\\EventListener\\ContaoHooks\\ImportFromCsvHookExample' => 'getImportFromCsvHookExampleService',
            'Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddNewsletterSubscriptionListener' => 'getAddNewsletterSubscriptionListenerService',
            'Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddPasswordListener' => 'getAddPasswordListenerService',
            'Markocupic\\ImportFromCsvBundle\\Import\\Field\\Formatter' => 'getFormatter2Service',
            'Markocupic\\ImportFromCsvBundle\\Import\\Field\\ImportValidator' => 'getImportValidatorService',
            'Markocupic\\ImportFromCsvBundle\\Import\\ImportFromCsv' => 'getImportFromCsv2Service',
            'Markocupic\\ImportFromCsvBundle\\Import\\ImportFromCsvHelper' => 'getImportFromCsvHelperService',
            'Markocupic\\ImportFromCsvBundle\\Logger\\ImportLogger' => 'getImportLoggerService',
            'Markocupic\\ImportFromCsvBundle\\MarkocupicImportFromCsvBundle' => 'getMarkocupicImportFromCsvBundleService',
            'Markocupic\\ImportFromCsvBundle\\Migration\\Version5Migration' => 'getVersion5MigrationService',
            'Markocupic\\ImportFromCsvBundle\\Model\\ImportFromCsvModel' => 'getImportFromCsvModelService',
            ...
            'Mvo\\ContaoGroupWidget\\EventListener\\GroupWidgetListener' => 'getGroupWidgetListenerService',
            'Oveleon\\ContaoCookiebar\\Command\\AnonymizeIpCommand' => 'getAnonymizeIpCommandService',
            'Oveleon\\ContaoCookiebar\\Controller\\ContentElement\\CookiebarOpenerController' => 'getCookiebarOpenerControllerService',
            'Oveleon\\ContaoCookiebar\\Controller\\CookiebarController' => 'getCookiebarControllerService',
            'Oveleon\\ContaoCookiebar\\Controller\\FrontendModule\\CookiebarOpenerController' => 'getCookiebarOpenerController2Service',
            'Oveleon\\ContaoCookiebar\\EventListener\\DataContainer\\CookieCallbackListener' => 'getCookieCallbackListenerService',
            'Oveleon\\ContaoCookiebar\\EventListener\\DataContainer\\CookieConfigCallbackListener' => 'getCookieConfigCallbackListenerService',
            'Oveleon\\ContaoCookiebar\\EventListener\\DataContainer\\CookieGroupCallbackListener' => 'getCookieGroupCallbackListenerService',
            'Oveleon\\ContaoCookiebar\\EventListener\\DataContainer\\CookiebarCallbackListener' => 'getCookiebarCallbackListenerService',
            'Oveleon\\ContaoCookiebar\\EventListener\\DataContainer\\PageCallbackListener' => 'getPageCallbackListenerService',
            'Oveleon\\ContaoCookiebar\\EventListener\\InsertTagsListener' => 'getInsertTagsListener3Service',
            'Oveleon\\ContaoCookiebar\\Exception\\NoCookiebarSpecifiedException' => 'getNoCookiebarSpecifiedExceptionService',
            'Oveleon\\ContaoCookiebar\\Export\\LogExport' => 'getLogExportService',
            'Oveleon\\ContaoCookiebar\\Migration\\ContaoCookiebarConsentModeMigration' => 'getContaoCookiebarConsentModeMigrationService',
            'Oveleon\\ContaoCookiebar\\Utils\\ScriptUtils' => 'getScriptUtilsService',
            'Pdir\\ContaoWebtoolsBundle\\EventListener\\BackendMenuListener' => 'getBackendMenuListenerService',
            'Pdir\\ContaoWebtoolsBundle\\EventListener\\DataContainer\\BackendUsabilityListener' => 'getBackendUsabilityListenerService',
            'Pdir\\ContaoWebtoolsBundle\\EventListener\\GeneratePageListener' => 'getGeneratePageListenerService',
            'Pdir\\MaeEventCategoriesBundle\\EventListener\\DataContainer\\CalendarEventsListener' => 'getCalendarEventsListenerService',
            'Pdir\\MaeEventCategoriesBundle\\EventListener\\GetAllEventsListener' => 'getGetAllEventsListenerService',
            'Pdir\\ThemeHelperBundle\\EventListener\\InsertTagsListener' => 'getInsertTagsListener4Service',
            'Sineos\\FileManagerBundle\\Controller\\FileUsage' => 'getFileUsageService',
            'Softleister\\BackupDbBundle\\Controller\\BackupDbController' => 'getBackupDbControllerService',
            ...
            'Tastaturberuf\\ContaoImageCopyrightBundle\\Controller\\ImageCopyrightListController' => 'getImageCopyrightListControllerService',
            'Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\DcaFilesListener' => 'getDcaFilesListenerService',
            'Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\DcaModuleListener' => 'getDcaModuleListenerService',
            'Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\ParseTemplateListener' => 'getParseTemplateListener2Service',
            'Terminal42\\ConditionalSelectMenuBundle\\EventListener\\ConditionFieldOptionsListener' => 'getConditionFieldOptionsListenerService',
            ...
            'Terminal42\\FolderpageBundle\\Controller\\FolderPageController' => 'getFolderPageControllerService',
            'Terminal42\\FolderpageBundle\\EventListener\\ConfigureFolderPageListener' => 'getConfigureFolderPageListenerService',
            'Terminal42\\FolderpageBundle\\EventListener\\DefaultPageTypeListener' => 'getDefaultPageTypeListenerService',
            'Terminal42\\FolderpageBundle\\EventListener\\PageBreadcrumbListener' => 'getPageBreadcrumbListenerService',
            'Terminal42\\FolderpageBundle\\EventListener\\PageStatusIconListener' => 'getPageStatusIconListenerService',
            'Terminal42\\LeadsBundle\\Controller\\LeadsExportController' => 'getLeadsExportControllerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportAccessListener' => 'getExportAccessListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportButtonsListener' => 'getExportButtonsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportFieldDefaultListener' => 'getExportFieldDefaultListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportFieldOptionsListener' => 'getExportFieldOptionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportFormatOptionsListener' => 'getExportFormatOptionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportOperationsListener' => 'getExportOperationsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\ExportTypeOptionsListener' => 'getExportTypeOptionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\FormConfigListener' => 'getFormConfigListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\FormFieldConfigListener' => 'getFormFieldConfigListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\FormMainOptionsListener' => 'getFormMainOptionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\LeadAccessListener' => 'getLeadAccessListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\LeadLabelListener' => 'getLeadLabelListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\LeadLanguageOptionsListener' => 'getLeadLanguageOptionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\LeadSearchListener' => 'getLeadSearchListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\DataContainer\\UserPermissionsListener' => 'getUserPermissionsListenerService',
            'Terminal42\\LeadsBundle\\EventListener\\ProcessFormDataListener' => 'getProcessFormDataListener3Service',
            'Terminal42\\LeadsBundle\\EventListener\\UserNavigationListener' => 'getUserNavigationListenerService',
            'Terminal42\\NewsNewsletterBundle\\EventListener\\NotificationOptionsListener' => 'getNotificationOptionsListenerService',
            'Terminal42\\NewsNewsletterBundle\\EventListener\\SendNewsletterListener' => 'getSendNewsletterListenerService',
            'Terminal42\\NewsNewsletterBundle\\NotificationCenter\\NewsNewsletterNotificationType' => 'getNewsNewsletterNotificationTypeService',
            'Terminal42\\NotificationCenterBundle\\Controller\\DownloadBulkyItemController' => 'getDownloadBulkyItemControllerService',
            'Terminal42\\NotificationCenterBundle\\EventListener\\Backend\\DataContainer\\FormListener' => 'getFormListener2Service',
            ...
            'Terminal42\\NotificationCenterBundle\\EventListener\\Newsletter\\ActivationListener' => 'getActivationListenerService',
            'Terminal42\\NotificationCenterBundle\\EventListener\\NotificationCenterProListener' => 'getNotificationCenterProListenerService',
            'Terminal42\\NotificationCenterBundle\\EventListener\\ProcessFormDataListener' => 'getProcessFormDataListener4Service',
            ...
            'Terminal42\\PageimageBundle\\Controller\\PageimageController' => 'getPageimageControllerService',
            'Terminal42\\PageimageBundle\\EventListener\\InsertTagsListener' => 'getInsertTagsListener5Service',
            'advanced_classes.listener.compile_form_fields' => 'getAdvancedClasses_Listener_CompileFormFieldsService',
            'advanced_classes.listener.data_container.ac_set' => 'getAdvancedClasses_Listener_DataContainer_AcSetService',
            'advanced_classes.listener.data_container.content' => 'getAdvancedClasses_Listener_DataContainer_ContentService',
            'advanced_classes.listener.data_container.form_field' => 'getAdvancedClasses_Listener_DataContainer_FormFieldService',
            'advanced_classes.listener.get_content_element' => 'getAdvancedClasses_Listener_GetContentElementService',
            'advanced_classes.listener.parse_template' => 'getAdvancedClasses_Listener_ParseTemplateService',
            'bugbuster.dlstats.insert_tags_listener' => 'getBugbuster_Dlstats_InsertTagsListenerService',
            'bugbuster.dlstatsexport.listener.panel' => 'getBugbuster_Dlstatsexport_Listener_PanelService',
            'cache.app_clearer' => 'getCache_AppClearerService',
            'cache.global_clearer' => 'getCache_GlobalClearerService',
            'cache.system_clearer' => 'getCache_SystemClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'calendar_extended.mcw.callbacks' => 'getCalendarExtended_Mcw_CallbacksService',
            'calendar_extended.module.callbacks' => 'getCalendarExtended_Module_CallbacksService',
            'code4nix_uri_signer.uri_signer' => 'getCode4nixUriSigner_UriSignerService',
            'codefog_tags.listener.data_container.tag' => 'getCodefogTags_Listener_DataContainer_TagService',
            'codefog_tags.listener.insert_tags' => 'getCodefogTags_Listener_InsertTagsService',
            'codefog_tags.listener.tag_manager' => 'getCodefogTags_Listener_TagManagerService',
            'codefog_tags.manager.terminal42_node' => 'getCodefogTags_Manager_Terminal42NodeService',
            'codefog_tags.manager_registry' => 'getCodefogTags_ManagerRegistryService',
            ...
            'contao.fragment._contao.content_element.cookiebar_opener' => 'getContao_Fragment_Contao_ContentElement_CookiebarOpenerService',
            ...
            'contao.fragment._contao.content_element.gallery_creator' => 'getContao_Fragment_Contao_ContentElement_GalleryCreatorService',
            'contao.fragment._contao.content_element.gallery_creator_news' => 'getContao_Fragment_Contao_ContentElement_GalleryCreatorNewsService',
            ...
            'contao.fragment._contao.frontend_module.check_listing' => 'getContao_Fragment_Contao_FrontendModule_CheckListingService',
            'contao.fragment._contao.frontend_module.cookiebar_opener' => 'getContao_Fragment_Contao_FrontendModule_CookiebarOpenerService',
            'contao.fragment._contao.frontend_module.event_registration_cancel' => 'getContao_Fragment_Contao_FrontendModule_EventRegistrationCancelService',
            'contao.fragment._contao.frontend_module.event_registration_confirm' => 'getContao_Fragment_Contao_FrontendModule_EventRegistrationConfirmService',
            'contao.fragment._contao.frontend_module.event_registration_form' => 'getContao_Fragment_Contao_FrontendModule_EventRegistrationFormService',
            'contao.fragment._contao.frontend_module.event_registration_list' => 'getContao_Fragment_Contao_FrontendModule_EventRegistrationListService',
            'contao.fragment._contao.frontend_module.feed_reader' => 'getContao_Fragment_Contao_FrontendModule_FeedReaderService',
            'contao.fragment._contao.frontend_module.image_copyright_list' => 'getContao_Fragment_Contao_FrontendModule_ImageCopyrightListService',
            'contao.fragment._contao.frontend_module.leadsoptin' => 'getContao_Fragment_Contao_FrontendModule_LeadsoptinService',
            ...
            'contao.fragment._contao.frontend_module.newsletterSubscribeNotificationCenter' => 'getContao_Fragment_Contao_FrontendModule_NewsletterSubscribeNotificationCenterService',
            'contao.fragment._contao.frontend_module.newsletterUnsubscribeNotificationCenter' => 'getContao_Fragment_Contao_FrontendModule_NewsletterUnsubscribeNotificationCenterService',
            'contao.fragment._contao.frontend_module.pageimage' => 'getContao_Fragment_Contao_FrontendModule_PageimageService',
            ...
            'contao.fragment._contao.frontend_module.visitors' => 'getContao_Fragment_Contao_FrontendModule_VisitorsService',
            ...
            'contao.listener.0wFBrYr' => 'getContao_Listener_0wFBrYrService',
            'contao.listener.K3PNvHW' => 'getContao_Listener_K3PNvHWService',
            ...
            'contao_cookiebar.listener.insert_tags' => 'getContaoCookiebar_Listener_InsertTagsService',
            ...
            'contao_pdfformsbundle.listener.insert_tags' => 'getContaoPdfformsbundle_Listener_InsertTagsService',
            'contao_pdfformsbundle.listener.prepare_form_data' => 'getContaoPdfformsbundle_Listener_PrepareFormDataService',
            'ctn.mate_theme.listener.hooks' => 'getCtn_MateTheme_Listener_HooksService',
            'ctn.materialiconsinserttag.listener.hooks' => 'getCtn_Materialiconsinserttag_Listener_HooksService',
            'ctn.themecomponentsbundle.eventlistener.generatepagehook' => 'getCtn_Themecomponentsbundle_Eventlistener_GeneratepagehookService',
            'ctn.themecomponentsbundle.eventlistener.parsefrontendtemplatehook' => 'getCtn_Themecomponentsbundle_Eventlistener_ParsefrontendtemplatehookService',
            'ctn.themecomponentsbundle.eventlistener.replaceinserttags' => 'getCtn_Themecomponentsbundle_Eventlistener_ReplaceinserttagsService',
            'debug.error_handler_configurator' => 'getDebug_ErrorHandlerConfiguratorService',
            'error_controller' => 'getErrorControllerService',
            'fragment.handler' => 'getFragment_HandlerService',
            'huh.ajax.action' => 'getHuh_Ajax_ActionService',
            'huh.ajax.token' => 'getHuh_Ajax_TokenService',
            'knp_menu.factory' => 'getKnpMenu_FactoryService',
            'mailer' => 'getMailerService',
            'markocupic.import_from_csv.session.attribute.array_attribute_bag' => 'getMarkocupic_ImportFromCsv_Session_Attribute_ArrayAttributeBagService',
            'markocupic.import_from_csv.session.factory' => 'getMarkocupic_ImportFromCsv_Session_FactoryService',
            'markocupic.zip_bundle.zip.zip' => 'getMarkocupic_ZipBundle_Zip_ZipService',
            ...
            'numero2_proper_filenames.listener.data_container.files' => 'getNumero2ProperFilenames_Listener_DataContainer_FilesService',
            'numero2_proper_filenames.listener.data_container.settings' => 'getNumero2ProperFilenames_Listener_DataContainer_SettingsService',
            'numero2_proper_filenames.listener.hooks.check_filenames' => 'getNumero2ProperFilenames_Listener_Hooks_CheckFilenamesService',
            ...
            'terminal42_insert_tags.dca' => 'getTerminal42InsertTags_DcaService',
            'terminal42_insert_tags.insert_tags' => 'getTerminal42InsertTags_InsertTagsService',
            'terminal42_node.listener.content' => 'getTerminal42Node_Listener_ContentService',
            'terminal42_node.listener.data_container' => 'getTerminal42Node_Listener_DataContainerService',
            'terminal42_node.listener.insert_tags' => 'getTerminal42Node_Listener_InsertTagsService',
            'terminal42_node.manager' => 'getTerminal42Node_ManagerService',
            'theme_helper.listener.insert_tags' => 'getThemeHelper_Listener_InsertTagsService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-utils-bundle/src/Util/Utils.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-utils-bundle/src/Twig/StringExtension.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/markocupic/contao-twig-assets/src/Twig/Extension/TwigAssetManager.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/bwein-net/contao-backend-customizer/src/EventListener/BackendResponseListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/bwein-net/contao-backend-customizer/src/ParameterBag/BackendParameterBag.php';
            include_once \dirname(__DIR__, 4).'/vendor/bwein-net/contao-backend-customizer/src/EventSubscriber/KernelRequestSubscriber.php';
            include_once \dirname(__DIR__, 4).'/vendor/oveleon/contao-cookiebar/src/EventListener/KernelRequestListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/oveleon/contao-cookiebar/src/EventSubscriber/KernelRequestSubscriber.php';
            include_once \dirname(__DIR__, 4).'/vendor/bugbuster/contao-clienthints-request-bundle/src/EventListener/RequestListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle/src/EventSubscriber/AddBackendAssetsSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/contao/core-bundle/contao/library/Contao/System.php';
            include_once \dirname(__DIR__, 4).'/vendor/contao/core-bundle/contao/library/Contao/Controller.php';
            include_once \dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-bundle/src/Resources/contao/classes/DlstatsHelper.php';
            include_once \dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-bundle/src/EventListener/DownloadResponseListener.php';
            include_once \dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle/src/EventSubscriber/LoadBackendAssetsSubscriber.php';
    ...
    /**
     * Gets the public 'HeimrichHannot\UtilsBundle\Util\Utils' shared autowired service.
     *
     * @return \HeimrichHannot\UtilsBundle\Util\Utils
     */
    protected static function getUtilsService($container)
    {
        return $container->services['HeimrichHannot\\UtilsBundle\\Util\\Utils'] = new \HeimrichHannot\UtilsBundle\Util\Utils((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'HeimrichHannot\\UtilsBundle\\Util\\AccordionUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\AccordionUtil', 'getAccordionUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\AnonymizeUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\AnonymizeUtil', 'getAnonymizeUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\ArrayUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\ArrayUtil', 'getArrayUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\BackendUiUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\BackendUiUtil', 'getBackendUiUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\ClassUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\ClassUtil', 'getClassUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\ContainerUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\ContainerUtil', 'getContainerUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\DatabaseUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\DatabaseUtil', 'getDatabaseUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\DcaUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\DcaUtil', 'getDcaUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\FileUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\FileUtil', 'getFileUtil2Service', true],
            'HeimrichHannot\\UtilsBundle\\Util\\FormatterUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\FormatterUtil', 'getFormatterUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\HtmlUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\HtmlUtil', 'getHtmlUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\LocaleUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\LocaleUtil', 'getLocaleUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\ModelUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\ModelUtil', 'getModelUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\RequestUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\RequestUtil', 'getRequestUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\RoutingUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\RoutingUtil', 'getRoutingUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\StringUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\StringUtil', 'getStringUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\UrlUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\UrlUtil', 'getUrlUtilService', true],
            'HeimrichHannot\\UtilsBundle\\Util\\UserUtil' => ['privates', 'HeimrichHannot\\UtilsBundle\\Util\\UserUtil', 'getUserUtilService', true],
        ], [
            'HeimrichHannot\\UtilsBundle\\Util\\AccordionUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\AccordionUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\AnonymizeUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\AnonymizeUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\ArrayUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\ArrayUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\BackendUiUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\BackendUiUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\ClassUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\ClassUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\ContainerUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\ContainerUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\DatabaseUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\DatabaseUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\DcaUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\DcaUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\FileUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\FileUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\FormatterUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\FormatterUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\HtmlUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\HtmlUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\LocaleUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\LocaleUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\ModelUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\ModelUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\RequestUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\RequestUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\RoutingUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\RoutingUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\StringUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\StringUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\UrlUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\UrlUtil',
            'HeimrichHannot\\UtilsBundle\\Util\\UserUtil' => 'HeimrichHannot\\UtilsBundle\\Util\\UserUtil',
        ]))->withContext('HeimrichHannot\\UtilsBundle\\Util\\Utils', $container));
    }

    /**
     * Gets the public 'Markocupic\GalleryCreatorBundle\EventSubscriber\AddBackendAssetsSubscriber' shared autowired service.
     *
     * @return \Markocupic\GalleryCreatorBundle\EventSubscriber\AddBackendAssetsSubscriber
     */
    protected static function getAddBackendAssetsSubscriberService($container)
    {
        return $container->services['Markocupic\\GalleryCreatorBundle\\EventSubscriber\\AddBackendAssetsSubscriber'] = new \Markocupic\GalleryCreatorBundle\EventSubscriber\AddBackendAssetsSubscriber(($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)));
    }

    /**
     * Gets the public 'Oveleon\ContaoCookiebar\EventListener\KernelRequestListener' shared autowired service.
     *
     * @return \Oveleon\ContaoCookiebar\EventListener\KernelRequestListener
     */
    protected static function getKernelRequestListenerService($container)
    {
        $a = ($container->services['contao.security.token_checker'] ?? self::getContao_Security_TokenCheckerService($container));

        if (isset($container->services['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener'])) {
            return $container->services['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener'];
        }

        return $container->services['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener'] = new \Oveleon\ContaoCookiebar\EventListener\KernelRequestListener(($container->services['translator'] ?? self::getTranslatorService($container)), $a, ($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)), ($container->privates['contao.csp.parser'] ?? self::getContao_Csp_ParserService($container)), 63072000, false, 'ccb_contao_token', false, false);
    }

    /**
     * Gets the public 'Oveleon\ContaoCookiebar\EventSubscriber\KernelRequestSubscriber' shared autowired service.
     *
     * @return \Oveleon\ContaoCookiebar\EventSubscriber\KernelRequestSubscriber
     */
    protected static function getKernelRequestSubscriberService($container)
    {
        return $container->services['Oveleon\\ContaoCookiebar\\EventSubscriber\\KernelRequestSubscriber'] = new \Oveleon\ContaoCookiebar\EventSubscriber\KernelRequestSubscriber(($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)));
    }
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        $e = new \Symfony\Component\Asset\PathPackage('assets/ace', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.36.5', '%s?v=%s'), $d);
        ...
        $g = new \Symfony\Component\Asset\PathPackage('assets/colorbox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.4.2', '%s?v=%s'), $d);
        ...
        $i = new \Symfony\Component\Asset\PathPackage('assets/contao', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('9.3.6', '%s?v=%s'), $d);
        $j = new \Symfony\Component\Asset\PathPackage('assets/datepicker', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.1', '%s?v=%s'), $d);
        ...
        $o = new \Symfony\Component\Asset\PathPackage('assets/mediabox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.4.3', '%s?v=%s'), $d);
        $p = new \Symfony\Component\Asset\PathPackage('assets/mootools', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.0.9', '%s?v=%s'), $d);
        $q = new \Symfony\Component\Asset\PathPackage('assets/simplemodal', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.2', '%s?v=%s'), $d);
        $r = new \Symfony\Component\Asset\PathPackage('assets/swipe', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.2.2', '%s?v=%s'), $d);
        $s = new \Symfony\Component\Asset\PathPackage('assets/swiper', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('11.1.15', '%s?v=%s'), $d);
        $t = new \Symfony\Component\Asset\PathPackage('assets/tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('4.0.2', '%s?v=%s'), $d);
        $u = new \Symfony\Component\Asset\PathPackage('assets/tablesorter', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.31.3.1', '%s?v=%s'), $d);
        $v = new \Symfony\Component\Asset\PathPackage('assets/tinymce4', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('6.8.5.1', '%s?v=%s'), $d);
        ...
        $x = new \Symfony\Component\Asset\PathPackage('heimrichhannot-contao-components/sortablejs', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.8.4', '%s?v=%s'), $d);
        ...
        $instance->addPackage('heimseiten_contao_google_fonts_roboto', new \Symfony\Component\Asset\PathPackage('bundles/heimseitencontaogooglefontsroboto', $a, $d));
        ...
        $instance->addPackage('ticker', new \Symfony\Component\Asset\PathPackage('bundles/ticker', $a, $d));
        $instance->addPackage('bwein_backend_customizer', new \Symfony\Component\Asset\PathPackage('bundles/bweinbackendcustomizer', $a, $d));
        $instance->addPackage('contao_cookiebar', new \Symfony\Component\Asset\PathPackage('bundles/contaocookiebar', $a, $d));
        $instance->addPackage('multi_column_wizard', new \Symfony\Component\Asset\PathPackage('bundles/multicolumnwizard', $a, $d));
        $instance->addPackage('heimseiten_contao_google_fonts_open_sans', new \Symfony\Component\Asset\PathPackage('bundles/heimseitencontaogooglefontsopensans', $a, $d));
        $instance->addPackage('file_manager', new \Symfony\Component\Asset\PathPackage('bundles/filemanager', $a, $d));
        $instance->addPackage('softleister_pdfforms', new \Symfony\Component\Asset\PathPackage('bundles/softleisterpdfforms', $a, $d));
        $instance->addPackage('markocupic_contao_twig_assets', new \Symfony\Component\Asset\PathPackage('bundles/markocupiccontaotwigassets', $a, $d));
        $instance->addPackage('markocupic_gallery_creator', new \Symfony\Component\Asset\PathPackage('bundles/markocupicgallerycreator', $a, $d));
        $instance->addPackage('contao_faq', new \Symfony\Component\Asset\PathPackage('bundles/contaofaq', $a, $d));
        $instance->addPackage('diversworld_contao_check', new \Symfony\Component\Asset\PathPackage('bundles/diversworldcontaocheck', $a, $d));
        $instance->addPackage('bug_buster_visitors', new \Symfony\Component\Asset\PathPackage('bundles/bugbustervisitors', $a, $d));
        ...
        $instance->addPackage('softleister_ce.be.remarks', new \Symfony\Component\Asset\PathPackage('bundles/softleisterce_be_remarks', $a, $d));
        $instance->addPackage('markocupic_zip', new \Symfony\Component\Asset\PathPackage('bundles/markocupiczip', $a, $d));
        $instance->addPackage('heimseiten_contao_sticky_footer_backend', new \Symfony\Component\Asset\PathPackage('bundles/heimseitencontaostickyfooterbackend', $a, $d));
        $instance->addPackage('diversworld_contao_ducapp', new \Symfony\Component\Asset\PathPackage('bundles/diversworldcontaoducapp', $a, $d));
        $instance->addPackage('terminal42_dcawizard', new \Symfony\Component\Asset\PathPackage('bundles/terminal42dcawizard', $a, $d));
        $instance->addPackage('heimrich_hannot_contao_multi_column_editor', new \Symfony\Component\Asset\PathPackage('bundles/heimrichhannotcontaomulticolumneditor', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/public/manifest.json'), $c, false), $d));
        $instance->addPackage('markocupic_import_from_csv', new \Symfony\Component\Asset\PathPackage('bundles/markocupicimportfromcsv', $a, $d));
        $instance->addPackage('bug_buster_dlstats', new \Symfony\Component\Asset\PathPackage('bundles/bugbusterdlstats', $a, $d));
        $instance->addPackage('mvo_contao_group_widget', new \Symfony\Component\Asset\PathPackage('bundles/mvocontaogroupwidget', $a, $d));
        $instance->addPackage('theme_helper', new \Symfony\Component\Asset\PathPackage('bundles/themehelper', $a, $d));
        $instance->addPackage('pdir_contao_sticky_footer', new \Symfony\Component\Asset\PathPackage('bundles/pdircontaostickyfooter', $a, $d));
        $instance->addPackage('markocupic_backend_password_recovery', new \Symfony\Component\Asset\PathPackage('bundles/markocupicbackendpasswordrecovery', $a, $d));
        $instance->addPackage('contao_news', new \Symfony\Component\Asset\PathPackage('bundles/contaonews', $a, $d));
        $instance->addPackage('terminal42_conditional_select_menu', new \Symfony\Component\Asset\PathPackage('bundles/terminal42conditionalselectmenu', $a, $d));
        $instance->addPackage('terminal42_leads', new \Symfony\Component\Asset\PathPackage('bundles/terminal42leads', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/vendor/terminal42/contao-leads/public/manifest.json'), $c, false), $d));
        $instance->addPackage('pdir_contao_webtools', new \Symfony\Component\Asset\PathPackage('bundles/pdircontaowebtools', $a, $d));
        $instance->addPackage('terminal42_notification_center', new \Symfony\Component\Asset\PathPackage('bundles/terminal42notificationcenter', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/vendor/terminal42/notification_center/public/manifest.json'), $c, false), $d));
        $instance->addPackage('contao_calendar', new \Symfony\Component\Asset\PathPackage('bundles/contaocalendar', $a, $d));
        $instance->addPackage('markocupic_contao_altcha_antispam', new \Symfony\Component\Asset\PathPackage('bundles/markocupiccontaoaltchaantispam', $a, $d));
        $instance->addPackage('contao_newsletter', new \Symfony\Component\Asset\PathPackage('bundles/contaonewsletter', $a, $d));
        $instance->addPackage('softleister_backup_db', new \Symfony\Component\Asset\PathPackage('bundles/softleisterbackupdb', $a, $d));
        $instance->addPackage('cgoit_calendar_extended', new \Symfony\Component\Asset\PathPackage('bundles/cgoitcalendarextended', $a, $d));
        $instance->addPackage('contao_dd_advanced_classes', new \Symfony\Component\Asset\PathPackage('bundles/contaoddadvancedclasses', $a, $d));
        $instance->addPackage('codefog_news_categories', new \Symfony\Component\Asset\PathPackage('bundles/codefognewscategories', $a, $d));
        $instance->addPackage('cgoit_leads_optin', new \Symfony\Component\Asset\PathPackage('bundles/cgoitleadsoptin', $a, $d));
        $instance->addPackage('contao_event_registration', new \Symfony\Component\Asset\PathPackage('bundles/contaoeventregistration', $a, $d));
        $instance->addPackage('codefog_tags', new \Symfony\Component\Asset\PathPackage('bundles/codefogtags', $a, $d));
        $instance->addPackage('terminal42_news_newsletter', new \Symfony\Component\Asset\PathPackage('bundles/terminal42newsnewsletter', $a, $d));
        $instance->addPackage('pdir_mae_event_categories', new \Symfony\Component\Asset\PathPackage('bundles/pdirmaeeventcategories', $a, $d));
        $instance->addPackage('contao_comments', new \Symfony\Component\Asset\PathPackage('bundles/contaocomments', $a, $d));
        $instance->addPackage('cgoit_form_fill_pdf', new \Symfony\Component\Asset\PathPackage('bundles/cgoitformfillpdf', $a, $d));
        $instance->addPackage('theme_components', new \Symfony\Component\Asset\PathPackage('bundles/themecomponents', $a, $d));
        $instance->addPackage('contao_themes_net_mate_theme', new \Symfony\Component\Asset\PathPackage('bundles/contaothemesnetmatetheme', $a, $d));
        ...
        $instance->addPackage('heimrichhannot-contao-components/sortablejs', $x);
        $instance->addPackage('contao-components/ace', $e);
        $instance->addPackage('contao-components/chosen', $f);
        $instance->addPackage('contao-components/colorbox', $g);
        $instance->addPackage('contao-components/colorpicker', $h);
    ...
    /**
     * Gets the public 'bugbuster.clienthintsrequest.kernelresponse_listener' shared autowired service.
     *
     * @return \BugBuster\ClientHintsRequestBundle\EventListener\RequestListener
     */
    protected static function getBugbuster_Clienthintsrequest_KernelresponseListenerService($container)
    {
        return $container->services['bugbuster.clienthintsrequest.kernelresponse_listener'] = new \BugBuster\ClientHintsRequestBundle\EventListener\RequestListener();
    }

    /**
     * Gets the public 'bugbuster.dlstats.kernelresponse_listener' shared autowired service.
     *
     * @return \BugBuster\DlstatsBundle\EventListener\DownloadResponseListener
     */
    protected static function getBugbuster_Dlstats_KernelresponseListenerService($container)
    {
        $a = ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container));

        if (isset($container->services['bugbuster.dlstats.kernelresponse_listener'])) {
            return $container->services['bugbuster.dlstats.kernelresponse_listener'];
        }
        ...
        return $container->services['bugbuster.dlstats.kernelresponse_listener'] = new \BugBuster\DlstatsBundle\EventListener\DownloadResponseListener($a, ($container->services['kernel'] ?? $container->get('kernel', 1)), ($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), $b);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lO2ND5vGjE', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zvCD9rHvyd', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H0yA8zMrPD', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y1BG8Y+ys7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('asndEp1gka', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getContao_Fragment_RegistryService($container)
    {
        ...
        $instance->add('contao.frontend_module.visitors', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.visitors', 'esi', ['ignore_errors' => false]));
        ...
        $instance->add('contao.frontend_module.cookiebar_opener', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.cookiebar_opener', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.check_listing', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.check_listing', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.image_copyright_list', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.image_copyright_list', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.pageimage', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.pageimage', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.lostPasswordNotificationCenter', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.lostPasswordNotificationCenter', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.registrationNotificationCenter', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.registrationNotificationCenter', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.newsletterSubscribeNotificationCenter', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.newsletterSubscribeNotificationCenter', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.newsletterUnsubscribeNotificationCenter', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.newsletterUnsubscribeNotificationCenter', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.leadsoptin', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.leadsoptin', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.event_registration_cancel', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.event_registration_cancel', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.event_registration_confirm', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.event_registration_confirm', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.event_registration_form', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.event_registration_form', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.frontend_module.event_registration_list', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.frontend_module.event_registration_list', 'forward', ['ignore_errors' => false]));
        ...
        $instance->add('contao.content_element.cookiebar_opener', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.content_element.cookiebar_opener', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.content_element.gallery_creator', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.content_element.gallery_creator', 'forward', ['ignore_errors' => false]));
        $instance->add('contao.content_element.gallery_creator_news', new \Contao\CoreBundle\Fragment\FragmentConfig('contao.fragment._contao.content_element.gallery_creator_news', 'forward', ['ignore_errors' => false]));
    ...
    protected static function getContao_FrameworkService($container)
    {
        ...
        $instance->setHookListeners(['executePostActions' => [[['HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\ExecutePostActionsListener', '__invoke'], ['Codefog\\HasteBundle\\EventListener\\DcaAjaxOperationsListener', 'onExecutePostActions'], ['Terminal42\\DcawizardBundle\\EventListener\\AjaxActionsListener', '__invoke']]], 'initializeSystem' => [255 => [['contao.listener.0wFBrYr', 'onInitializeSystem'], ['contao.listener.K3PNvHW', 'onInitializeSystem']], 100 => [['Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\InitializeSystemListener', '__invoke']], 0 => [['HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\InitializeSystemListener', '__invoke'], ['contao.listener.data_container.preview_link', 'unloadModuleWithoutPreviewScript'], ['HeimrichHannot\\AjaxBundle\\EventListener\\Contao\\InitializeSystemListener', '__invoke'], ['Terminal42\\LeadsBundle\\EventListener\\UserNavigationListener', 'onInitializeSystem']]], 'loadDataContainer' => [200 => [['contao.listener.data_container.default_global_operations', '__invoke'], ['contao.listener.data_container.default_operations', '__invoke'], ['contao.listener.data_container.enum_options', '__invoke']], 1 => [['Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\DcaModuleListener', 'loadDataContainer']], 0 => [['HeimrichHannot\\MultiColumnEditorBundle\\EventListener\\Contao\\LoadDataContainerListener', '__invoke'], ['HeimrichHannot\\UtilsBundle\\EventListener\\DcaField\\DateAddedFieldListener', 'onLoadDataContainer'], ['HeimrichHannot\\UtilsBundle\\EventListener\\DcaField\\DcaAuthorListener', 'onLoadDataContainer'], ['contao.listener.data_container.preview_link', 'unloadTableWithoutPreviewScript'], ['contao.listener.data_container.record_preview', 'registerDeleteCallbacks'], ['Terminal42\\FolderpageBundle\\EventListener\\DefaultPageTypeListener', '__invoke'], ['Terminal42\\FolderpageBundle\\EventListener\\PageBreadcrumbListener', '__invoke'], ['Codefog\\HasteBundle\\EventListener\\DcaAjaxOperationsListener', 'onLoadDataContainer'], ['Codefog\\HasteBundle\\DcaRelationsManager', 'addRelationCallbacks'], ['Terminal42\\DcawizardBundle\\EventListener\\CloseModalListener', '__invoke'], ['Terminal42\\DcawizardBundle\\EventListener\\FixRefererListener', '__invoke'], ['Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\DcaFilesListener', 'addFields'], ['Pdir\\ContaoWebtoolsBundle\\EventListener\\DataContainer\\BackendUsabilityListener', '__invoke'], ['Terminal42\\NotificationCenterBundle\\EventListener\\NotificationCenterProListener', '__invoke'], ['contao_comments.listener.data_container.add_comment_fields', '__invoke']], -16 => [['contao.listener.data_container_callback', 'onLoadDataContainer']], -256 => [['Mvo\\ContaoGroupWidget\\EventListener\\GroupWidgetListener', 'initializeGroups']]], 'getSystemMessages' => [[['contao.listener.administrator_email', '__invoke'], ['contao.listener.data_container.personal_data_password', '__invoke'], ['numero2_proper_filenames.listener.hooks.check_filenames', 'checkMissingSettings']]], 'addCustomRegexp' => [100 => [['Markocupic\\ContaoBundleCreatorBundle\\EventListener\\ContaoHook\\AddCustomRegexpListener', 'cbcbRegexp']], 0 => [['contao.listener.widget.custom_rgxp', '__invoke'], ['contao.listener.widget.http_url', '__invoke']]], 'compileFormFields' => [[['Terminal42\\ConditionalformfieldsBundle\\EventListener\\FormListener', 'onCompileFormFields']]], 'loadFormField' => [[['Terminal42\\ConditionalformfieldsBundle\\EventListener\\FormListener', 'onLoadFormField'], ['numero2_proper_filenames.listener.hooks.check_filenames', 'renameFileUpload'], ['advanced_classes.listener.compile_form_fields', '__invoke']]], 'validateFormField' => [[['Terminal42\\ConditionalformfieldsBundle\\EventListener\\FormListener', 'onValidateFormField']]], 'getPageStatusIcon' => [[['Terminal42\\FolderpageBundle\\EventListener\\PageStatusIconListener', '__invoke'], ['contao_news.listener.data_container.page', 'getStatusIcon']]], 'getFrontendModule' => [[['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener', 'onParseLegacyTemplates'], ['Codefog\\HasteBundle\\EventListener\\AjaxReloadListener', 'onGetFrontendModule']]], 'getContentElement' => [[['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener', 'onParseLegacyTemplates'], ['Codefog\\HasteBundle\\EventListener\\AjaxReloadListener', 'onGetContentElement'], ['advanced_classes.listener.get_content_element', '__invoke']]], 'generatePage' => [100 => [['ctn.themecomponentsbundle.eventlistener.generatepagehook', '__invoke']], 0 => [['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener', 'onGeneratePage'], ['contao_news.listener.generate_page', '__invoke'], ['Pdir\\ContaoWebtoolsBundle\\EventListener\\GeneratePageListener', '__invoke'], ['contao_calendar.listener.generate_page', '__invoke']]], 'replaceInsertTags' => [100 => [['ctn.themecomponentsbundle.eventlistener.replaceinserttags', '__invoke']], 0 => [['contao_cookiebar.listener.insert_tags', '__invoke'], ['terminal42_insert_tags.insert_tags', '__invoke'], ['contao_pdfformsbundle.listener.insert_tags', '__invoke'], ['contao_pdfformsbundle.listener.insert_tags', '__invoke'], ['Codefog\\HasteBundle\\EventListener\\InsertTagsListener', '__invoke'], ['bugbuster.dlstats.insert_tags_listener', '__invoke'], ['bugbuster.dlstats.insert_tags_listener', '__invoke'], ['Pdir\\ThemeHelperBundle\\EventListener\\InsertTagsListener', '__invoke'], ['Terminal42\\PageimageBundle\\EventListener\\InsertTagsListener', '__invoke'], ['Codefog\\NewsCategoriesBundle\\EventListener\\InsertTagsListener', '__invoke'], ['ContaoThemesNet\\MateThemeBundle\\EventListener\\HookListener', '__invoke'], ['ctn.mate_theme.listener.hooks', '__invoke']]], 'prepareFormData' => [100 => [['Cgoit\\FormFillPdfBundle\\EventListener\\PrepareFormDataListener', '__invoke']], 0 => [['contao_pdfformsbundle.listener.prepare_form_data', '__invoke'], ['contao_pdfformsbundle.listener.prepare_form_data', '__invoke'], ['Cgoit\\LeadsOptinBundle\\Hook\\PrepareFormDataHook', '__invoke']]], 'galleryCreatorGenerateFrontendTemplate' => [100 => [['Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\GalleryCreatorFrontendTemplateListener', '__invoke']]], 'galleryCreatorImagePostInsert' => [100 => [['Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\GalleryCreatorImagePostInsertListener', '__invoke']]], 'parseBackendTemplate' => [100 => [['Markocupic\\GalleryCreatorBundle\\EventListener\\ContaoHook\\ParseBackendTemplate', '__invoke']]], 'reviseTable' => [[['Codefog\\HasteBundle\\DcaRelationsManager', 'reviseRelatedRecords']]], 'importFromCsv' => [[['Markocupic\\ImportFromCsvBundle\\EventListener\\ContaoHooks\\ImportFromCsvHookExample', '__invoke']]], 'parseTemplate' => [[['Markocupic\\BackendPasswordRecoveryBundle\\EventListener\\Contao\\ParseTemplateListener', '__invoke'], ['Tastaturberuf\\ContaoImageCopyrightBundle\\EventListener\\ParseTemplateListener', 'onParseTemplate'], ['advanced_classes.listener.parse_template', '__invoke'], ['InspiredMinds\\ContaoEventRegistration\\EventListener\\EventParseTemplateListener', '__invoke']]], 'parseWidget' => [[['InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener', '__invoke']]], 'processFormData' => [10 => [['InspiredMinds\\ContaoEventRegistration\\EventListener\\EventRegistrationFormListener', '__invoke']], 0 => [['Terminal42\\LeadsBundle\\EventListener\\ProcessFormDataListener', '__invoke'], ['Terminal42\\NotificationCenterBundle\\EventListener\\ProcessFormDataListener', '__invoke'], ['Markocupic\\ContaoAltchaAntispam\\EventListener\\ProcessFormDataListener', '__invoke'], ['Cgoit\\LeadsOptinBundle\\Hook\\ProcessFormDataHook', '__invoke'], ['Cgoit\\FormFillPdfBundle\\EventListener\\ProcessFormDataListener', '__invoke']]], 'loadLanguageFile' => [[['Terminal42\\LeadsBundle\\EventListener\\UserNavigationListener', 'onLoadLanguageFile']]], 'getUserNavigation' => [[['Terminal42\\LeadsBundle\\EventListener\\UserNavigationListener', 'onGetUserNavigation']]], 'activateAccount' => [[['Terminal42\\NotificationCenterBundle\\EventListener\\RegistrationListener', 'sendActivationEmail']]], 'updatePersonalData' => [[['Terminal42\\NotificationCenterBundle\\EventListener\\UpdatePersonalDataListener', 'updatePersonalData']]], 'activateRecipient' => [[['Terminal42\\NotificationCenterBundle\\EventListener\\Newsletter\\ActivationListener', '__invoke']]], 'postUpload' => [[['numero2_proper_filenames.listener.hooks.check_filenames', 'renameFilesBackend']]], 'getAllEvents' => [100 => [['Pdir\\MaeEventCategoriesBundle\\EventListener\\GetAllEventsListener', 'onGetAllEvents']], -100 => [['Cgoit\\CalendarExtendedBundle\\Hook\\GetAllEventsHook', '__invoke']]], 'parseFrontendTemplate' => [100 => [['ctn.themecomponentsbundle.eventlistener.parsefrontendtemplatehook', '__invoke']], 0 => [['Cgoit\\CalendarExtendedBundle\\Hook\\ParseFrontendTemplateHook', '__invoke']]], 'changelanguageNavigation' => [[['Codefog\\NewsCategoriesBundle\\EventListener\\ChangeLanguageListener', '__invoke']]], 'newsListCountItems' => [[['Codefog\\NewsCategoriesBundle\\EventListener\\NewsListener', 'onNewsListCountItems']]], 'newsListFetchItems' => [[['Codefog\\NewsCategoriesBundle\\EventListener\\NewsListener', 'onNewsListFetchItems']]], 'parseArticles' => [[['Codefog\\NewsCategoriesBundle\\EventListener\\TemplateListener', '__invoke']]]]);
    ...
    protected static function getContao_Routing_PageRegistryService($container)
    {
        ...
        $instance->add('folder', new \Contao\CoreBundle\Routing\Page\RouteConfig(NULL, NULL, NULL, [], [], ['_controller' => 'Terminal42\\FolderpageBundle\\Controller\\FolderPageController'], []), NULL, false);
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/vendor/contao/core-bundle/src/Entity'), (\dirname(__DIR__, 4).'/vendor/mvo/contao-group-widget/src/Entity')], false);

        $c->addDriver($d, 'Contao\\CoreBundle\\Entity');
        $c->addDriver($d, 'Mvo\\ContaoGroupWidget\\Entity');

        $a->setEntityNamespaces(['ContaoCoreBundle' => 'Contao\\CoreBundle\\Entity', 'MvoContaoGroupWidgetBundle' => 'Mvo\\ContaoGroupWidget\\Entity']);
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'Bwein\\BackendCustomizer\\EventListener\\BackendResponseListener')] fn () => ($container->privates['Bwein\\BackendCustomizer\\EventListener\\BackendResponseListener'] ?? self::getBackendResponseListenerService($container)), '__invoke'], 0);
        $instance->addListener('kernel.request', [#[\Closure(name: 'Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener')] fn () => ($container->services['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener'] ?? self::getKernelRequestListenerService($container)), 'onKernelRequest'], 0);
        $instance->addListener('kernel.response', [#[\Closure(name: 'Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener')] fn () => ($container->services['Oveleon\\ContaoCookiebar\\EventListener\\KernelRequestListener'] ?? self::getKernelRequestListenerService($container)), 'onKernelResponse'], 0);
        $instance->addListener('dc-general.factory.build-data-definition', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\DcGeneral\\UpdateDataDefinition')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\DcGeneral\\UpdateDataDefinition'] ??= new \MenAtWork\MultiColumnWizardBundle\EventListener\DcGeneral\UpdateDataDefinition()), 'addMcwFields'], -5000);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.get-options', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\GetOptionsBridge')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\GetOptionsBridge'] ?? $container->load('getGetOptionsBridgeService')), 'executeEvent'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.get-tiny-mce', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\TinyMce')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\TinyMce'] ??= new \MenAtWork\MultiColumnWizardBundle\EventListener\Mcw\TinyMce()), 'executeEvent'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.get-date-picker', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\DatePicker')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\DatePicker'] ??= new \MenAtWork\MultiColumnWizardBundle\EventListener\Mcw\DatePicker()), 'executeEvent'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.get-color-picker', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\ColorPicker')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\ColorPicker'] ?? $container->load('getColorPickerService')), 'executeEvent'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.get-dca-picker-wizard', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\DcaPickerWizard')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\DcaPickerWizard'] ??= new \MenAtWork\MultiColumnWizardBundle\EventListener\Mcw\DcaPickerWizard()), 'executeEvent'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.create-widget', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\CreateWidget')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\CreateWidget'] ?? $container->load('getCreateWidgetService')), 'createWidgetContao'], 0);
        $instance->addListener('men-at-work.multi-column-wizard-bundle.create-widget', [#[\Closure(name: 'MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\CreateWidget')] fn () => ($container->privates['MenAtWork\\MultiColumnWizardBundle\\EventListener\\Mcw\\CreateWidget'] ?? $container->load('getCreateWidgetService')), 'createWidgetDcGeneral'], 0);
        $instance->addListener('kernel.response', [#[\Closure(name: 'bugbuster.clienthintsrequest.kernelresponse_listener', class: 'BugBuster\\ClientHintsRequestBundle\\EventListener\\RequestListener')] fn () => ($container->services['bugbuster.clienthintsrequest.kernelresponse_listener'] ??= new \BugBuster\ClientHintsRequestBundle\EventListener\RequestListener()), 'onKernelResponse'], 0);
        ...
        $instance->addListener('import_from_csv.post_import', [#[\Closure(name: 'Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddNewsletterSubscriptionListener')] fn () => ($container->services['Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddNewsletterSubscriptionListener'] ?? $container->load('getAddNewsletterSubscriptionListenerService')), 'addNewsletterSubscription'], 0);
        $instance->addListener('import_from_csv.post_import', [#[\Closure(name: 'Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddPasswordListener')] fn () => ($container->services['Markocupic\\ImportFromCsvBundle\\EventListener\\PostImport\\AddPasswordListener'] ?? $container->load('getAddPasswordListenerService')), 'addPassword'], 0);
        $instance->addListener('kernel.response', [#[\Closure(name: 'bugbuster.dlstats.kernelresponse_listener', class: 'BugBuster\\DlstatsBundle\\EventListener\\DownloadResponseListener')] fn () => ($container->services['bugbuster.dlstats.kernelresponse_listener'] ?? self::getBugbuster_Dlstats_KernelresponseListenerService($container)), '__invoke'], 0);
        ...
        $instance->addListener('contao.backend_menu_build', [#[\Closure(name: 'Pdir\\ContaoWebtoolsBundle\\EventListener\\BackendMenuListener')] fn () => ($container->services['Pdir\\ContaoWebtoolsBundle\\EventListener\\BackendMenuListener'] ?? $container->load('getBackendMenuListenerService')), '__invoke'], -255);
        $instance->addListener('kernel.reset', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\Config\\ConfigLoader')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\Config\\ConfigLoader'] ?? $container->load('getConfigLoaderService')), 'reset'], 0);
        $instance->addListener('contao.backend_menu_build', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\Backend\\BackendMenuListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\Backend\\BackendMenuListener'] ?? $container->load('getBackendMenuListener2Service')), '__invoke'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\GetTokenDefinitionsForNotificationTypeEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\AdminEmailTokenListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\AdminEmailTokenListener'] ?? $container->load('getAdminEmailTokenListenerService')), 'onGetTokenDefinitions'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\CreateParcelEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\AdminEmailTokenListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\AdminEmailTokenListener'] ?? $container->load('getAdminEmailTokenListenerService')), 'onCreateParcel'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\GetTokenDefinitionsForNotificationTypeEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\BulkyItemsTokenListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\BulkyItemsTokenListener'] ?? $container->load('getBulkyItemsTokenListenerService')), 'onGetTokenDefinitions'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\CreateParcelEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\BulkyItemsTokenListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\BulkyItemsTokenListener'] ?? $container->load('getBulkyItemsTokenListenerService')), 'onCreateParcel'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\CreateParcelEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\DisableDeliveryListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\DisableDeliveryListener'] ??= new \Terminal42\NotificationCenterBundle\EventListener\DisableDeliveryListener()), '__invoke'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\GetNotificationTypeForModuleConfigEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\NotificationTypeForModuleListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\NotificationTypeForModuleListener'] ??= new \Terminal42\NotificationCenterBundle\EventListener\NotificationTypeForModuleListener()), '__invoke'], 0);
        $instance->addListener('Doctrine\\ORM\\Tools\\Event\\GenerateSchemaEventArgs', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\DoctrineSchemaListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\DoctrineSchemaListener'] ??= new \Terminal42\NotificationCenterBundle\EventListener\DoctrineSchemaListener()), '__invoke'], 0);
        $instance->addListener('Contao\\CoreBundle\\Filesystem\\Dbafs\\RetrieveDbafsMetadataEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\DbafsMetadataListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\DbafsMetadataListener'] ??= new \Terminal42\NotificationCenterBundle\EventListener\DbafsMetadataListener()), 'enhanceMetadata'], 0);
        $instance->addListener('Contao\\CoreBundle\\Filesystem\\Dbafs\\StoreDbafsMetadataEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\DbafsMetadataListener')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\DbafsMetadataListener'] ??= new \Terminal42\NotificationCenterBundle\EventListener\DbafsMetadataListener()), 'normalizeMetadata'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\ReceiptEvent', [#[\Closure(name: 'Terminal42\\NotificationCenterBundle\\EventListener\\LogUnsuccessfulDeliveries')] fn () => ($container->privates['Terminal42\\NotificationCenterBundle\\EventListener\\LogUnsuccessfulDeliveries'] ?? $container->load('getLogUnsuccessfulDeliveriesService')), '__invoke'], 0);
        ...
        $instance->addListener('Contao\\NewsBundle\\Event\\FetchArticlesForFeedEvent', [#[\Closure(name: 'Codefog\\NewsCategoriesBundle\\EventListener\\NewsFeedListener')] fn () => ($container->privates['Codefog\\NewsCategoriesBundle\\EventListener\\NewsFeedListener'] ?? $container->load('getNewsFeedListenerService')), 'onFetchArticlesForFeed'], 0);
        $instance->addListener('Contao\\NewsBundle\\Event\\TransformArticleForFeedEvent', [#[\Closure(name: 'Codefog\\NewsCategoriesBundle\\EventListener\\NewsFeedListener')] fn () => ($container->privates['Codefog\\NewsCategoriesBundle\\EventListener\\NewsFeedListener'] ?? $container->load('getNewsFeedListenerService')), 'onTransformArticleForFeed'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\CreateParcelEvent', [#[\Closure(name: 'InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\AddEventDataListener')] fn () => ($container->privates['InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\AddEventDataListener'] ?? $container->load('getAddEventDataListenerService')), '__invoke'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\GetTokenDefinitionsForNotificationTypeEvent', [#[\Closure(name: 'InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\EventRegistrationTokensListener')] fn () => ($container->privates['InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\EventRegistrationTokensListener'] ?? $container->load('getEventRegistrationTokensListenerService')), '__invoke'], 0);
        $instance->addListener('Terminal42\\NotificationCenterBundle\\Event\\GetNotificationTypeForModuleConfigEvent', [#[\Closure(name: 'InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\GetNotificationTypeForModuleConfigEventListener')] fn () => ($container->privates['InspiredMinds\\ContaoEventRegistration\\EventListener\\NotificationCenter\\GetNotificationTypeForModuleConfigEventListener'] ??= new \InspiredMinds\ContaoEventRegistration\EventListener\NotificationCenter\GetNotificationTypeForModuleConfigEventListener()), '__invoke'], 0);
        $instance->addListener('HeimrichHannot\\UtilsBundle\\Event\\ExtendEntityFinderEvent', [#[\Closure(name: 'HeimrichHannot\\UtilsBundle\\EventListener\\ExtendEntityFinderSubscriber')] fn () => ($container->privates['HeimrichHannot\\UtilsBundle\\EventListener\\ExtendEntityFinderSubscriber'] ??= new \HeimrichHannot\UtilsBundle\EventListener\ExtendEntityFinderSubscriber()), 'onExtendEntityFinderEvent'], 0);
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'Bwein\\BackendCustomizer\\EventSubscriber\\KernelRequestSubscriber')] fn () => ($container->privates['Bwein\\BackendCustomizer\\EventSubscriber\\KernelRequestSubscriber'] ?? self::getKernelRequestSubscriber2Service($container)), 'onKernelRequest'], 0);
        $instance->addListener('kernel.request', [#[\Closure(name: 'Oveleon\\ContaoCookiebar\\EventSubscriber\\KernelRequestSubscriber')] fn () => ($container->services['Oveleon\\ContaoCookiebar\\EventSubscriber\\KernelRequestSubscriber'] ?? self::getKernelRequestSubscriberService($container)), 'onKernelRequest'], 0);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AddStandardTagsMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AddStandardTagsMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\AddStandardTagsMaker()), 'addTagsToStorage'], 10000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AddStandardTagsMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AddStandardTagsMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\AddStandardTagsMaker()), 'addFilesToStorage'], 10000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AlterRootComposerJsonMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AlterRootComposerJsonMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\AlterRootComposerJsonMaker()), 'addTagsToStorage'], -10000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AlterRootComposerJsonMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\AlterRootComposerJsonMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\AlterRootComposerJsonMaker()), 'addFilesToStorage'], -10000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\BundleClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\BundleClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\BundleClassMaker()), 'addTagsToStorage'], 990);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\BundleClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\BundleClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\BundleClassMaker()), 'addFilesToStorage'], 990);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ComposerJsonMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ComposerJsonMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ComposerJsonMaker()), 'addTagsToStorage'], 1000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ComposerJsonMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ComposerJsonMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ComposerJsonMaker()), 'addFilesToStorage'], 1000);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoBackendModuleMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoBackendModuleMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoBackendModuleMaker()), 'addTagsToStorage'], 930);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoBackendModuleMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoBackendModuleMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoBackendModuleMaker()), 'addFilesToStorage'], 930);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoContentElementMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoContentElementMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoContentElementMaker()), 'addTagsToStorage'], 910);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoContentElementMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoContentElementMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoContentElementMaker()), 'addFilesToStorage'], 910);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoFrontendModuleMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoFrontendModuleMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoFrontendModuleMaker()), 'addTagsToStorage'], 920);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoFrontendModuleMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoFrontendModuleMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoFrontendModuleMaker()), 'addFilesToStorage'], 920);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoManagerPluginClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoManagerPluginClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoManagerPluginClassMaker()), 'addTagsToStorage'], 970);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoManagerPluginClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContaoManagerPluginClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContaoManagerPluginClassMaker()), 'addFilesToStorage'], 970);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContinuousIntegrationMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContinuousIntegrationMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContinuousIntegrationMaker()), 'addTagsToStorage'], 960);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContinuousIntegrationMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\ContinuousIntegrationMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\ContinuousIntegrationMaker()), 'addFilesToStorage'], 960);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\CustomRouteMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\CustomRouteMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\CustomRouteMaker()), 'addTagsToStorage'], 900);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\CustomRouteMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\CustomRouteMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\CustomRouteMaker()), 'addFilesToStorage'], 900);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\DependencyInjectionExtensionClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\DependencyInjectionExtensionClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\DependencyInjectionExtensionClassMaker()), 'addTagsToStorage'], 980);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\DependencyInjectionExtensionClassMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\DependencyInjectionExtensionClassMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\DependencyInjectionExtensionClassMaker()), 'addFilesToStorage'], 980);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\EasyCodingStandardMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\EasyCodingStandardMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\EasyCodingStandardMaker()), 'addTagsToStorage'], 940);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\EasyCodingStandardMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\EasyCodingStandardMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\EasyCodingStandardMaker()), 'addFilesToStorage'], 940);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\FriendlyConfigurationMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\FriendlyConfigurationMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\FriendlyConfigurationMaker()), 'addTagsToStorage'], 890);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\FriendlyConfigurationMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\FriendlyConfigurationMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\FriendlyConfigurationMaker()), 'addFilesToStorage'], 890);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\MiscFilesMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\MiscFilesMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\MiscFilesMaker()), 'addTagsToStorage'], 950);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\MiscFilesMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\MiscFilesMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\MiscFilesMaker()), 'addFilesToStorage'], 950);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.tags.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\SessionAttributeBagMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\SessionAttributeBagMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\SessionAttributeBagMaker()), 'addTagsToStorage'], 1010);
        $instance->addListener('markocupic.contao_bundle_creator_bundle.maker.added', [#[\Closure(name: 'Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\SessionAttributeBagMaker')] fn () => ($container->privates['Markocupic\\ContaoBundleCreatorBundle\\EventSubscriber\\Maker\\SessionAttributeBagMaker'] ??= new \Markocupic\ContaoBundleCreatorBundle\EventSubscriber\Maker\SessionAttributeBagMaker()), 'addFilesToStorage'], 1010);
        $instance->addListener('kernel.request', [#[\Closure(name: 'Markocupic\\GalleryCreatorBundle\\EventSubscriber\\AddBackendAssetsSubscriber')] fn () => ($container->services['Markocupic\\GalleryCreatorBundle\\EventSubscriber\\AddBackendAssetsSubscriber'] ?? self::getAddBackendAssetsSubscriberService($container)), 'onKernelRequest'], 0);
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'Markocupic\\BackendPasswordRecoveryBundle\\EventSubscriber\\LoadBackendAssetsSubscriber')] fn () => ($container->privates['Markocupic\\BackendPasswordRecoveryBundle\\EventSubscriber\\LoadBackendAssetsSubscriber'] ?? self::getLoadBackendAssetsSubscriberService($container)), 'loadAssets'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginFailureEvent', [#[\Closure(name: 'Markocupic\\BackendPasswordRecoveryBundle\\EventSubscriber\\LoginFailureSubscriber')] fn () => ($container->privates['Markocupic\\BackendPasswordRecoveryBundle\\EventSubscriber\\LoginFailureSubscriber'] ??= new \Markocupic\BackendPasswordRecoveryBundle\EventSubscriber\LoginFailureSubscriber()), 'onLoginFailure'], 0);
    ...
    protected static function getSecurity_HelperService($container)
    {
        return $container->services['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'Markocupic\\BackendPasswordRecoveryBundle\\Security\\Authenticator\\Authenticator' => ['privates', 'Markocupic\\BackendPasswordRecoveryBundle\\Security\\Authenticator\\Authenticator', 'getAuthenticatorService', true],
            ...
            'Markocupic\\BackendPasswordRecoveryBundle\\Security\\Authenticator\\Authenticator' => '?',
    ...
    protected static function getTwigService($container)
    {
        ...
        $container->services['twig'] = $instance = new \Twig\Environment($a, ['debug' => true, 'strict_variables' => true, 'autoescape' => 'name', 'cache' => ($container->targetDir.''.'/twig'), 'charset' => 'UTF-8']);
        ...
        $f = ($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container));
        ...
        $i = ($container->services['knp_menu.matcher'] ?? self::getKnpMenu_MatcherService($container));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension(($container->services['security.authorization_checker'] ?? self::getSecurity_AuthorizationCheckerService($container)), new \Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator($e, ($container->services['security.firewall.map'] ?? self::getSecurity_Firewall_MapService($container)), $f)));
        $instance->addExtension(new \HeimrichHannot\UtilsBundle\Twig\StringExtension(($container->services['HeimrichHannot\\UtilsBundle\\Util\\Utils'] ?? self::getUtilsService($container))));
        ...
        $instance->addExtension(new \Markocupic\ContaoTwigAssets\Twig\Extension\TwigAssetManager(\dirname(__DIR__, 4)));
    ...
    /**
     * Gets the private 'Bwein\BackendCustomizer\EventListener\BackendResponseListener' shared autowired service.
     *
     * @return \Bwein\BackendCustomizer\EventListener\BackendResponseListener
     */
    protected static function getBackendResponseListenerService($container)
    {
        return $container->privates['Bwein\\BackendCustomizer\\EventListener\\BackendResponseListener'] = new \Bwein\BackendCustomizer\EventListener\BackendResponseListener(($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)), new \Bwein\BackendCustomizer\ParameterBag\BackendParameterBag(['env_title' => 'DUC Darmstadt e. V.', 'env_color' => '9caf06', 'header_title' => 'DUC Darmstadt e. V.', 'header_color' => '#003399', 'header_invert' => false, 'main_color' => NULL]));
    }

    /**
     * Gets the private 'Bwein\BackendCustomizer\EventSubscriber\KernelRequestSubscriber' shared autowired service.
     *
     * @return \Bwein\BackendCustomizer\EventSubscriber\KernelRequestSubscriber
     */
    protected static function getKernelRequestSubscriber2Service($container)
    {
        return $container->privates['Bwein\\BackendCustomizer\\EventSubscriber\\KernelRequestSubscriber'] = new \Bwein\BackendCustomizer\EventSubscriber\KernelRequestSubscriber(($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)));
    }

    /**
     * Gets the private 'Markocupic\BackendPasswordRecoveryBundle\EventSubscriber\LoadBackendAssetsSubscriber' shared autowired service.
     *
     * @return \Markocupic\BackendPasswordRecoveryBundle\EventSubscriber\LoadBackendAssetsSubscriber
     */
    protected static function getLoadBackendAssetsSubscriberService($container)
    {
        return $container->privates['Markocupic\\BackendPasswordRecoveryBundle\\EventSubscriber\\LoadBackendAssetsSubscriber'] = new \Markocupic\BackendPasswordRecoveryBundle\EventSubscriber\LoadBackendAssetsSubscriber(($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)));
    }
    ...
    protected static function getCache_AnnotationsService($container)
    {
        ...
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3rA6kpSfYd', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), $a));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nbQtTs5blD', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Dca2Reve0z', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0al50Wp48E', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('naj8WPDtyc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gLKxlLHnYv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getContao_ControllerResolverService($container)
    {
        ...
        $b->allowControllers(['BugBuster\\DlstatsBundle\\Controller\\DlstatsController', 'BugBuster\\VisitorsBundle\\Controller\\VisitorsFeController', 'BugBuster\\VisitorsBundle\\Controller\\VisitorsController', 'BugBuster\\VisitorsBundle\\Controller\\FrontendModule\\VisitorsFrontendController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController', 'Contao\\CoreBundle\\Controller\\BackendController', 'Contao\\CoreBundle\\Controller\\BackendPreviewController', 'Contao\\CoreBundle\\Controller\\BackendPreviewSwitchController', 'Contao\\CoreBundle\\Controller\\CaptchaController', 'Contao\\CoreBundle\\Controller\\ContentElement\\AccordionController', 'Contao\\CoreBundle\\Controller\\ContentElement\\CodeController', 'Contao\\CoreBundle\\Controller\\ContentElement\\DescriptionListController', 'Contao\\CoreBundle\\Controller\\ContentElement\\DownloadsController', 'Contao\\CoreBundle\\Controller\\ContentElement\\ElementGroupController', 'Contao\\CoreBundle\\Controller\\ContentElement\\HeadlineController', 'Contao\\CoreBundle\\Controller\\ContentElement\\HtmlController', 'Contao\\CoreBundle\\Controller\\ContentElement\\HyperlinkController', 'Contao\\CoreBundle\\Controller\\ContentElement\\ImagesController', 'Contao\\CoreBundle\\Controller\\ContentElement\\ListController', 'Contao\\CoreBundle\\Controller\\ContentElement\\MarkdownController', 'Contao\\CoreBundle\\Controller\\ContentElement\\PlayerController', 'Contao\\CoreBundle\\Controller\\ContentElement\\SwiperController', 'Contao\\CoreBundle\\Controller\\ContentElement\\TableController', 'Contao\\CoreBundle\\Controller\\ContentElement\\TemplateController', 'Contao\\CoreBundle\\Controller\\ContentElement\\TeaserController', 'Contao\\CoreBundle\\Controller\\ContentElement\\TextController', 'Contao\\CoreBundle\\Controller\\ContentElement\\ToplinkController', 'Contao\\CoreBundle\\Controller\\ContentElement\\UnfilteredHtmlController', 'Contao\\CoreBundle\\Controller\\ContentElement\\VideoController', 'Contao\\CoreBundle\\Controller\\CspReporterController', 'Contao\\CoreBundle\\Controller\\FaviconController', 'Contao\\CoreBundle\\Controller\\FrontendController', 'Contao\\CoreBundle\\Controller\\FrontendModule\\FeedReaderController', 'Contao\\CoreBundle\\Controller\\FrontendModule\\RootPageDependentModulesController', 'Contao\\CoreBundle\\Controller\\FrontendModule\\TemplateController', 'Contao\\CoreBundle\\Controller\\FrontendModule\\TwoFactorController', 'Contao\\CoreBundle\\Controller\\FrontendModule\\UnfilteredHtmlController', 'Contao\\CoreBundle\\Controller\\ImagesController', 'Contao\\CoreBundle\\Controller\\InsertTagsController', 'Contao\\CoreBundle\\Controller\\Page\\ErrorPageController', 'Contao\\CoreBundle\\Controller\\Page\\RootPageController', 'Contao\\CoreBundle\\Controller\\PreviewLinkController', 'Contao\\CoreBundle\\Controller\\RobotsTxtController', 'Contao\\CoreBundle\\Controller\\SitemapController', 'Oveleon\\ContaoCookiebar\\Controller\\ContentElement\\CookiebarOpenerController', 'Oveleon\\ContaoCookiebar\\Controller\\FrontendModule\\CookiebarOpenerController', 'Sineos\\FileManagerBundle\\Controller\\FileUsage', 'Markocupic\\GalleryCreatorBundle\\Controller\\ContentElement\\GalleryCreatorController', 'Markocupic\\GalleryCreatorBundle\\Controller\\ContentElement\\GalleryCreatorNewsController', 'Diversworld\\ContaoCheckBundle\\Controller\\FrontendModule\\CheckListingController', 'Diversworld\\ContaoCheckBundle\\Controller\\MyCustomController', 'Diversworld\\ContaoDucappBundle\\Controller\\MyCustomController', 'Markocupic\\ImportFromCsvBundle\\Contao\\Controller\\ImportAjaxController', 'Markocupic\\ImportFromCsvBundle\\Contao\\Controller\\MountAppAjaxController', 'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\ResetVerifyController', 'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\SendEmailConfirmController', 'Markocupic\\BackendPasswordRecoveryBundle\\Controller\\UserIdentifierFormController', 'Contao\\NewsBundle\\Controller\\Page\\NewsFeedController', 'Tastaturberuf\\ContaoImageCopyrightBundle\\Controller\\ImageCopyrightListController', 'Terminal42\\PageimageBundle\\Controller\\PageimageController', 'Terminal42\\LeadsBundle\\Controller\\LeadsExportController', 'Softleister\\BackupDbBundle\\Controller\\BackupDbController', 'Cgoit\\LeadsOptinBundle\\Controller\\Module\\LeadsOptInModule', 'InspiredMinds\\ContaoEventRegistration\\Controller\\EventRegistrationExportController', 'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationCancelController', 'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationConfirmController', 'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationFormController', 'InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationListController', 'BugBuster\\DlstatsExportBundle\\Controller\\ExportController']);
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        ...
        return $container->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['.debug.security.voter.Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter'] ?? $container->load('getBackendAccessVoterService'));
            yield 6 => ($container->privates['.debug.security.voter.contao.security.backend_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_BackendAccessVoterService'));
            yield 7 => ($container->privates['.debug.security.voter.contao.security.data_container.article_content_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ArticleContentVoterService'));
            yield 8 => ($container->privates['.debug.security.voter.contao.security.data_container.content_composition_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentCompositionVoterService'));
            yield 9 => ($container->privates['.debug.security.voter.contao.security.data_container.content_element_nesting_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentElementNestingVoterService'));
            yield 10 => ($container->privates['.debug.security.voter.contao.security.data_container.content_element_type_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ContentElementTypeVoterService'));
            yield 11 => ($container->privates['.debug.security.voter.contao.security.data_container.favorites_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FavoritesVoterService'));
            yield 12 => ($container->privates['.debug.security.voter.contao.security.data_container.form_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FormAccessVoterService'));
            yield 13 => ($container->privates['.debug.security.voter.contao.security.data_container.form_field_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FormFieldAccessVoterService'));
            yield 14 => ($container->privates['.debug.security.voter.contao.security.data_container.frontend_module_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_FrontendModuleVoterService'));
            yield 15 => ($container->privates['.debug.security.voter.contao.security.data_container.image_size_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ImageSizeAccessVoterService'));
            yield 16 => ($container->privates['.debug.security.voter.contao.security.data_container.image_size_item_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_ImageSizeItemAccessVoterService'));
            yield 17 => ($container->privates['.debug.security.voter.contao.security.data_container.layout_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_LayoutAccessVoterService'));
            yield 18 => ($container->privates['.debug.security.voter.contao.security.data_container.page_permission_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_PagePermissionVoterService'));
            yield 19 => ($container->privates['.debug.security.voter.contao.security.data_container.page_type_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_PageTypeAccessVoterService'));
            yield 20 => ($container->privates['.debug.security.voter.contao.security.data_container.undo_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_UndoVoterService'));
            yield 21 => ($container->privates['.debug.security.voter.contao.security.data_container.user_access_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DataContainer_UserAccessVoterService'));
            yield 22 => ($container->privates['.debug.security.voter.contao.security.member_group_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_MemberGroupVoterService'));
            yield 23 => ($container->privates['.debug.security.voter.Markocupic\\GalleryCreatorBundle\\Security\\Voter\\AlbumVoter'] ?? $container->load('getAlbumVoter2Service'));
            yield 24 => ($container->privates['.debug.security.voter.contao_faq.security.faq_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoFaq_Security_FaqAccessVoterService'));
            yield 25 => ($container->privates['.debug.security.voter.contao_faq.security.faq_category_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoFaq_Security_FaqCategoryAccessVoterService'));
            yield 26 => ($container->privates['.debug.security.voter.contao_news.security.news_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsAccessVoterService'));
            yield 27 => ($container->privates['.debug.security.voter.contao_news.security.news_archive_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsArchiveAccessVoterService'));
            yield 28 => ($container->privates['.debug.security.voter.contao_news.security.news_content_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNews_Security_NewsContentVoterService'));
            yield 29 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarAccessVoterService'));
            yield 30 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_content_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarContentVoterService'));
            yield 31 => ($container->privates['.debug.security.voter.contao_calendar.security.calendar_events_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoCalendar_Security_CalendarEventsAccessVoterService'));
            yield 32 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterAccessVoterService'));
            yield 33 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_channel_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterChannelAccessVoterService'));
            yield 34 => ($container->privates['.debug.security.voter.contao_newsletter.security.newsletter_recipients_access_voter'] ?? $container->load('get_Debug_Security_Voter_ContaoNewsletter_Security_NewsletterRecipientsAccessVoterService'));
            yield 35 => ($container->privates['.debug.security.voter.Codefog\\NewsCategoriesBundle\\Security\\Voter\\DataContainer\\NewsCategoriesVoter'] ?? $container->load('getNewsCategoriesVoterService'));
            yield 36 => ($container->privates['.debug.security.voter.contao.security.default_data_container_voter'] ?? $container->load('get_Debug_Security_Voter_Contao_Security_DefaultDataContainerVoterService'));
        }, 37), new \Contao\CoreBundle\Security\Authentication\ContaoStrategy(new \Symfony\Component\Security\Core\Authorization\Strategy\AffirmativeStrategy(false), new \Symfony\Component\Security\Core\Authorization\Strategy\PriorityStrategy(), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a)));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vczAQDV7VQ', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZwKLZC2E0X', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getSessionListenerService($container)
    {
        return $container->privates['session_listener'] = new \Symfony\Component\HttpKernel\EventListener\SessionListener(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'session_factory' => ['services', 'markocupic.import_from_csv.session.factory', 'getMarkocupic_ImportFromCsv_Session_FactoryService', true],
        ], [
            'logger' => '?',
            'request_stack' => '?',
            'session_collector' => '?',
    ...
    protected static function getTranslator_DefaultService($container)
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => ['php'], 'translation.loader.yml' => ['yaml', 'yml'], 'translation.loader.xliff' => ['xlf', 'xliff'], 'translation.loader.po' => ['po'], 'translation.loader.mo' => ['mo'], 'translation.loader.qt' => ['ts'], 'translation.loader.csv' => ['csv'], 'translation.loader.res' => ['res'], 'translation.loader.dat' => ['dat'], 'translation.loader.ini' => ['ini'], 'translation.loader.json' => ['json']], ['cache_dir' => ($container->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.af.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.af.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.af.xlf')], 'ar' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ar.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ar.xliff')], 'az' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.az.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.az.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.az.xlf')], 'be' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.be.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.be.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.be.xlf')], 'bg' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bg.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.bg.xliff')], 'bs' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.bs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.bs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.bs.xlf')], 'ca' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ca.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ca.xliff')], 'cs' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.cs.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.cs.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.cs.xlf'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations/messages.cs.yml')], 'cy' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.cy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.cy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.cy.xlf')], 'da' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.da.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.da.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.da.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.da.xliff')], 'de' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.de.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.de.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.de.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.de.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.de.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.de.xlf'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalformfields/translations/conditionalformfields.de.yaml'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations/messages.de.yml'), (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/translations/im_contao_event_registration.de.yaml'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations/messages.de.yml')], 'el' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.el.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.el.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.el.xlf')], 'en' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.en.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.en.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.en.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.en.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.en.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.en.xlf'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalformfields/translations/conditionalformfields.en.yaml'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations/messages.en.yml'), (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/translations/im_contao_event_registration.en.yaml'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations/messages.en.yml')], 'es' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.es.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.es.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.es.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.es.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.es.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.es.xlf')], 'et' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.et.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.et.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.et.xlf')], 'eu' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.eu.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.eu.xliff')], 'fa' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fa.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fa.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fa.xlf')], 'fi' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fi.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.fi.xliff')], 'fr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.fr.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.fr.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.fr.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.fr.xlf')], 'gl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.gl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.gl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.gl.xlf')], 'he' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.he.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.he.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.he.xlf')], 'hr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hr.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.hr.yml')], 'hu' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hu.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.hu.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.hu.xliff')], 'hy' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.hy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.hy.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.hy.xlf')], 'id' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.id.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.id.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.id.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.id.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.id.xliff')], 'it' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.it.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.it.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.it.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.it.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.it.xlf')], 'ja' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ja.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.ja.xlf'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations/messages.ja.yml')], 'lb' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lb.xlf')], 'lt' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lt.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.lt.xliff')], 'lv' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.lv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.lv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.lv.xlf'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.lv.xlf')], 'mk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.mk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.mk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.mk.xlf')], 'mn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.mn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.mn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.mn.xlf')], 'my' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.my.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.my.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.my.xlf')], 'nb' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nb.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nb.xliff')], 'nl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nl.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.nl.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nl.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.nl.xlf')], 'nn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.nn.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.nn.xliff')], 'no' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.no.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.no.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.no.xlf')], 'pl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.pl.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pl.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.pl.xlf'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations/messages.pl.yml')], 'pt' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.pt.xlf')], 'pt_BR' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.pt_BR.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt_BR.xliff')], 'ro' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ro.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.ro.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ro.xliff')], 'ru' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.ru.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ru.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.ru.xlf'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations/messages.ru.yml'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations/messages.ru.yml')], 'sk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sk.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.sk.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sk.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.sk.xlf')], 'sl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sl.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sl.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.sl.xlf')], 'sq' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sq.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sq.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sq.xlf')], 'sr_Cyrl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Cyrl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Cyrl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Cyrl.xlf')], 'sr_Latn' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sr_Latn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sr_Latn.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sr_Latn.xlf')], 'sv' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.sv.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.sv.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sv.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.sv.xlf')], 'th' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.th.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.th.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.th.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.th.xliff')], 'tl' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tl.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tl.xlf')], 'tr' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.tr.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.tr.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.tr.xliff'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.tr.xlf')], 'uk' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uk.xlf'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations/SchebTwoFactorBundle.uk.yml'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.uk.xliff')], 'ur' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.ur.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.ur.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.ur.xlf')], 'uz' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.uz.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.uz.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.uz.xlf')], 'vi' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.vi.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.vi.xliff')], 'zh_CN' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_CN.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_CN.xliff')], 'zh_TW' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations/validators.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations/validators.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations/security.zh_TW.xlf'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_TW.xliff')], 'bs_Latn_BA' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.bs_Latn_BA.xliff')], 'eo' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.eo.xliff')], 'hr_HR' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.hr_HR.xliff')], 'ky' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.ky.xliff')], 'pt_PT' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.pt_PT.xliff')], 'sr_Latin' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.sr_Latin.xliff')], 'zh' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh.xliff')], 'zh_HK' => [(\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations/time.zh_HK.xliff')], 'sr' => [(\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations/ContaoManagerBundle.sr.xlf')]], 'scanned_directories' => [(\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/scheb/2fa-bundle/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-time-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao/manager-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalformfields/translations'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/translations'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations'), (\dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/monolog-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/friendsofsymfony/http-cache-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/nelmio/cors-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/twig/extra-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/code4nix/uri-signer/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/web-profiler-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/knplabs/knp-menu-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/debug-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/symfony-cmf/routing-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/twig-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/service-annotation-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao/core-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/league/flysystem-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-roboto-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-utils-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/do-while/contao-ticker-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-folderpage/translations'), (\dirname(__DIR__, 4).'/vendor/bwein-net/contao-backend-customizer/translations'), (\dirname(__DIR__, 4).'/vendor/oveleon/contao-cookiebar/translations'), (\dirname(__DIR__, 4).'/vendor/menatwork/contao-multicolumnwizard-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-inserttags/translations'), (\dirname(__DIR__, 4).'/vendor/contao-themes-net/material-icons-inserttag/translations'), (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-open-sans-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/sineos/filemanager-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-clienthints-request-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/do-while/contao-pdfforms-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/contao-bundle-creator-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-botdetection-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/contao-twig-assets/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao/faq-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/diversworld/contao-check-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-visitors-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/codefog/contao-haste/translations'), (\dirname(__DIR__, 4).'/vendor/do-while/contao-ce_be_remarks/src/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/zip-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-sticky-footer-backend-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/diversworld/contao-ducapp-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/dcawizard/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/import-from-csv-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/mvo/contao-group-widget/translations'), (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-ajax-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/pdir/contao-theme-helper-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/pdir/contao-sticky-footer/src/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao/news-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/tastaturberuf/contao-image-copyright-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-pageimage/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalselectmenu/translations'), (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-backend-forms/src/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-leads/translations'), (\dirname(__DIR__, 4).'/vendor/contao/listing-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/pdir/contao-webtools/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/notification_center/translations'), (\dirname(__DIR__, 4).'/vendor/contao/calendar-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/markocupic/contao-altcha-antispam/translations'), (\dirname(__DIR__, 4).'/vendor/contao/newsletter-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/numero2/contao-proper-filenames/src/translations'), (\dirname(__DIR__, 4).'/vendor/do-while/contao-backupdb-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/cgoit/calendar-extended-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao-dd/advanced-classes-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/codefog/contao-news_categories/translations'), (\dirname(__DIR__, 4).'/vendor/cgoit/contao-leads-optin-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-node/translations'), (\dirname(__DIR__, 4).'/vendor/danielgausi/contao-calendareditor-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/codefog/tags-bundle/src/translations'), (\dirname(__DIR__, 4).'/vendor/terminal42/contao-news_newsletter/translations'), (\dirname(__DIR__, 4).'/vendor/marebe1602/mae_event_categories/translations'), (\dirname(__DIR__, 4).'/vendor/contao/comments-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/cgoit/contao-form-fill-pdf-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/cgoit/contao-cmace-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao-themes-net/theme-components-bundle/translations'), (\dirname(__DIR__, 4).'/vendor/contao-themes-net/mate-theme-bundle/translations'), (\dirname(__DIR__, 4).'/translations')], 'cache_vary' => ['scanned_directories' => ['vendor/symfony/validator/Resources/translations', 'vendor/symfony/form/Resources/translations', 'vendor/symfony/security-core/Resources/translations', 'vendor/scheb/2fa-bundle/Resources/translations', 'vendor/knplabs/knp-time-bundle/translations', 'vendor/contao/manager-bundle/translations', 'vendor/terminal42/contao-conditionalformfields/translations', 'vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/translations', 'vendor/inspiredminds/contao-event-registration/translations', 'vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/translations', 'vendor/doctrine/doctrine-bundle/translations', 'vendor/symfony/framework-bundle/translations', 'vendor/symfony/monolog-bundle/translations', 'vendor/friendsofsymfony/http-cache-bundle/src/translations', 'vendor/nelmio/cors-bundle/translations', 'vendor/nelmio/security-bundle/src/translations', 'vendor/twig/extra-bundle/translations', 'vendor/code4nix/uri-signer/translations', 'vendor/symfony/web-profiler-bundle/translations', 'vendor/knplabs/knp-menu-bundle/translations', 'vendor/symfony/debug-bundle/translations', 'vendor/symfony-cmf/routing-bundle/src/translations', 'vendor/symfony/twig-bundle/translations', 'vendor/terminal42/service-annotation-bundle/src/translations', 'vendor/symfony/security-bundle/translations', 'vendor/contao/core-bundle/translations', 'vendor/league/flysystem-bundle/src/translations', 'vendor/heimseiten/contao-google-fonts-roboto-bundle/src/translations', 'vendor/heimrichhannot/contao-utils-bundle/translations', 'vendor/do-while/contao-ticker-bundle/translations', 'vendor/terminal42/contao-folderpage/translations', 'vendor/bwein-net/contao-backend-customizer/translations', 'vendor/oveleon/contao-cookiebar/translations', 'vendor/menatwork/contao-multicolumnwizard-bundle/src/translations', 'vendor/terminal42/contao-inserttags/translations', 'vendor/contao-themes-net/material-icons-inserttag/translations', 'vendor/heimseiten/contao-google-fonts-open-sans-bundle/src/translations', 'vendor/sineos/filemanager-bundle/translations', 'vendor/bugbuster/contao-clienthints-request-bundle/translations', 'vendor/do-while/contao-pdfforms-bundle/src/translations', 'vendor/markocupic/contao-bundle-creator-bundle/translations', 'vendor/bugbuster/contao-botdetection-bundle/src/translations', 'vendor/markocupic/contao-twig-assets/translations', 'vendor/markocupic/gallery-creator-bundle/translations', 'vendor/contao/faq-bundle/translations', 'vendor/diversworld/contao-check-bundle/translations', 'vendor/bugbuster/contao-visitors-bundle/src/translations', 'vendor/codefog/contao-haste/translations', 'vendor/do-while/contao-ce_be_remarks/src/translations', 'vendor/markocupic/zip-bundle/src/translations', 'vendor/heimseiten/contao-sticky-footer-backend-bundle/src/translations', 'vendor/diversworld/contao-ducapp-bundle/translations', 'vendor/terminal42/dcawizard/translations', 'vendor/markocupic/import-from-csv-bundle/translations', 'vendor/bugbuster/contao-dlstats-bundle/src/translations', 'vendor/mvo/contao-group-widget/translations', 'vendor/heimrichhannot/contao-ajax-bundle/src/translations', 'vendor/pdir/contao-theme-helper-bundle/translations', 'vendor/pdir/contao-sticky-footer/src/translations', 'vendor/markocupic/backend-password-recovery-bundle/translations', 'vendor/contao/news-bundle/translations', 'vendor/tastaturberuf/contao-image-copyright-bundle/translations', 'vendor/terminal42/contao-pageimage/translations', 'vendor/terminal42/contao-conditionalselectmenu/translations', 'vendor/inspiredminds/contao-backend-forms/src/translations', 'vendor/terminal42/contao-leads/translations', 'vendor/contao/listing-bundle/translations', 'vendor/pdir/contao-webtools/translations', 'vendor/terminal42/notification_center/translations', 'vendor/contao/calendar-bundle/translations', 'vendor/markocupic/contao-altcha-antispam/translations', 'vendor/contao/newsletter-bundle/translations', 'vendor/numero2/contao-proper-filenames/src/translations', 'vendor/do-while/contao-backupdb-bundle/src/translations', 'vendor/cgoit/calendar-extended-bundle/translations', 'vendor/contao-dd/advanced-classes-bundle/translations', 'vendor/codefog/contao-news_categories/translations', 'vendor/cgoit/contao-leads-optin-bundle/translations', 'vendor/terminal42/contao-node/translations', 'vendor/danielgausi/contao-calendareditor-bundle/src/translations', 'vendor/codefog/tags-bundle/src/translations', 'vendor/terminal42/contao-news_newsletter/translations', 'vendor/marebe1602/mae_event_categories/translations', 'vendor/contao/comments-bundle/translations', 'vendor/cgoit/contao-form-fill-pdf-bundle/translations', 'vendor/cgoit/contao-cmace-bundle/translations', 'vendor/contao-themes-net/theme-components-bundle/translations', 'vendor/contao-themes-net/mate-theme-bundle/translations', 'translations']]], []);
    ...
    protected static function getTwig_Loader_ChainService($container)
    {
        ...
        $a = new \Contao\CoreBundle\Twig\Loader\FailTolerantFilesystemLoader([], \dirname(__DIR__, 4));
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/contao/core-bundle/templates'), 'ContaoCore');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/contao/core-bundle/templates'), '!ContaoCore');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle/templates'), 'MarkocupicGalleryCreator');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle/templates'), '!MarkocupicGalleryCreator');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/diversworld/contao-check-bundle/templates'), 'DiversworldContaoCheck');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/diversworld/contao-check-bundle/templates'), '!DiversworldContaoCheck');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/diversworld/contao-ducapp-bundle/templates'), 'DiversworldContaoDucapp');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/diversworld/contao-ducapp-bundle/templates'), '!DiversworldContaoDucapp');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/views'), 'HeimrichHannotContaoMultiColumnEditor');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/views'), '!HeimrichHannotContaoMultiColumnEditor');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/import-from-csv-bundle/templates'), 'MarkocupicImportFromCsv');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/import-from-csv-bundle/templates'), '!MarkocupicImportFromCsv');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/mvo/contao-group-widget/Resources/views'), 'MvoContaoGroupWidget');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/mvo/contao-group-widget/Resources/views'), '!MvoContaoGroupWidget');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle/templates'), 'MarkocupicBackendPasswordRecovery');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle/templates'), '!MarkocupicBackendPasswordRecovery');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/terminal42/notification_center/templates'), 'Terminal42NotificationCenter');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/terminal42/notification_center/templates'), '!Terminal42NotificationCenter');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/templates'), 'ContaoEventRegistration');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/templates'), '!ContaoEventRegistration');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/views'), 'BugBusterContaoDlstatsExport');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/views'), '!BugBusterContaoDlstatsExport');
        ...
        $instance->addLoader(($container->services['contao.twig.filesystem_loader'] ?? self::getContao_Twig_FilesystemLoaderService($container)));
        $instance->addLoader($a);
        $instance->addLoader(new \Twig\Loader\FilesystemLoader([], \dirname(__DIR__, 4)));
    ...
    /**
     * Gets the public 'huh.ajax' alias.
     *
     * @return object The "HeimrichHannot\AjaxBundle\Manager\AjaxManager" service.
     */
    protected static function getHuh_AjaxService($container)
    {
        trigger_deprecation('heimrichhannot/contao-ajax-bundle', '1.3', 'The "huh.ajax" service alias is deprecated. You should stop using it, as it will be removed in the future.');

        return $container->get('HeimrichHannot\\AjaxBundle\\Manager\\AjaxManager');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'Code4NixUriSigner' => 'Code4Nix\\UriSigner\\Code4NixUriSigner',
                ...
                'HeimseitenContaoGoogleFontsRobotoBundle' => 'Heimseiten\\ContaoGoogleFontsRobotoBundle\\HeimseitenContaoGoogleFontsRobotoBundle',
                'Terminal42ConditionalformfieldsBundle' => 'Terminal42\\ConditionalformfieldsBundle\\Terminal42ConditionalformfieldsBundle',
                'HeimrichHannotUtilsBundle' => 'HeimrichHannot\\UtilsBundle\\HeimrichHannotUtilsBundle',
                'TickerBundle' => 'Softleister\\TickerBundle\\TickerBundle',
                'Terminal42FolderpageBundle' => 'Terminal42\\FolderpageBundle\\Terminal42FolderpageBundle',
                'BweinBackendCustomizerBundle' => 'Bwein\\BackendCustomizer\\BweinBackendCustomizerBundle',
                'ContaoCookiebar' => 'Oveleon\\ContaoCookiebar\\ContaoCookiebar',
                'MultiColumnWizardBundle' => 'MenAtWork\\MultiColumnWizardBundle\\MultiColumnWizardBundle',
                'Terminal42InsertTagsBundle' => 'Terminal42\\InsertTagsBundle\\Terminal42InsertTagsBundle',
                ...
                'HeimseitenContaoGoogleFontsOpenSansBundle' => 'Heimseiten\\ContaoGoogleFontsOpenSansBundle\\HeimseitenContaoGoogleFontsOpenSansBundle',
                'FileManagerBundle' => 'Sineos\\FileManagerBundle\\FileManagerBundle',
                'BugBusterClientHintsRequestBundle' => 'BugBuster\\ClientHintsRequestBundle\\BugBusterClientHintsRequestBundle',
                'SoftleisterPdfformsBundle' => 'Softleister\\PdfformsBundle\\SoftleisterPdfformsBundle',
                'MarkocupicContaoBundleCreatorBundle' => 'Markocupic\\ContaoBundleCreatorBundle\\MarkocupicContaoBundleCreatorBundle',
                'BugBusterBotdetectionBundle' => 'BugBuster\\BotdetectionBundle\\BugBusterBotdetectionBundle',
                'MarkocupicContaoTwigAssets' => 'Markocupic\\ContaoTwigAssets\\MarkocupicContaoTwigAssets',
                'MarkocupicGalleryCreatorBundle' => 'Markocupic\\GalleryCreatorBundle\\MarkocupicGalleryCreatorBundle',
                'ContaoFaqBundle' => 'Contao\\FaqBundle\\ContaoFaqBundle',
                'DiversworldContaoCheckBundle' => 'Diversworld\\ContaoCheckBundle\\DiversworldContaoCheckBundle',
                'BugBusterVisitorsBundle' => 'BugBuster\\VisitorsBundle\\BugBusterVisitorsBundle',
                'CodefogHasteBundle' => 'Codefog\\HasteBundle\\CodefogHasteBundle',
                'SoftleisterCe_be_remarksBundle' => 'Softleister\\Ce_be_remarksBundle\\SoftleisterCe_be_remarksBundle',
                'MarkocupicZipBundle' => 'Markocupic\\ZipBundle\\MarkocupicZipBundle',
                'HeimseitenContaoStickyFooterBackendBundle' => 'Heimseiten\\ContaoStickyFooterBackendBundle\\HeimseitenContaoStickyFooterBackendBundle',
                'DiversworldContaoDucappBundle' => 'Diversworld\\ContaoDucappBundle\\DiversworldContaoDucappBundle',
                'Terminal42DcawizardBundle' => 'Terminal42\\DcawizardBundle\\Terminal42DcawizardBundle',
                'HeimrichHannotContaoMultiColumnEditorBundle' => 'HeimrichHannot\\MultiColumnEditorBundle\\HeimrichHannotContaoMultiColumnEditorBundle',
                'MarkocupicImportFromCsvBundle' => 'Markocupic\\ImportFromCsvBundle\\MarkocupicImportFromCsvBundle',
                'BugBusterDlstatsBundle' => 'BugBuster\\DlstatsBundle\\BugBusterDlstatsBundle',
                'MvoContaoGroupWidgetBundle' => 'Mvo\\ContaoGroupWidget\\MvoContaoGroupWidgetBundle',
                'HeimrichHannotContaoAjaxBundle' => 'HeimrichHannot\\AjaxBundle\\HeimrichHannotContaoAjaxBundle',
                'ThemeHelperBundle' => 'Pdir\\ThemeHelperBundle\\ThemeHelperBundle',
                'PdirContaoStickyFooterBundle' => 'Pdir\\ContaoStickyFooterBundle\\PdirContaoStickyFooterBundle',
                'MarkocupicBackendPasswordRecoveryBundle' => 'Markocupic\\BackendPasswordRecoveryBundle\\MarkocupicBackendPasswordRecoveryBundle',
                'ContaoNewsBundle' => 'Contao\\NewsBundle\\ContaoNewsBundle',
                'TastaturberufContaoImageCopyrightBundle' => 'Tastaturberuf\\ContaoImageCopyrightBundle\\TastaturberufContaoImageCopyrightBundle',
                'Terminal42PageimageBundle' => 'Terminal42\\PageimageBundle\\Terminal42PageimageBundle',
                'Terminal42ConditionalSelectMenuBundle' => 'Terminal42\\ConditionalSelectMenuBundle\\Terminal42ConditionalSelectMenuBundle',
                'ContaoBackendFormsBundle' => 'InspiredMinds\\ContaoBackendFormsBundle\\ContaoBackendFormsBundle',
                'Terminal42LeadsBundle' => 'Terminal42\\LeadsBundle\\Terminal42LeadsBundle',
                'ContaoListingBundle' => 'Contao\\ListingBundle\\ContaoListingBundle',
                'PdirContaoWebtoolsBundle' => 'Pdir\\ContaoWebtoolsBundle\\PdirContaoWebtoolsBundle',
                ...
                'MarkocupicContaoAltchaAntispam' => 'Markocupic\\ContaoAltchaAntispam\\MarkocupicContaoAltchaAntispam',
                'ContaoNewsletterBundle' => 'Contao\\NewsletterBundle\\ContaoNewsletterBundle',
                'ProperFilenamesBundle' => 'numero2\\ProperFilenamesBundle\\ProperFilenamesBundle',
                'SoftleisterBackupDbBundle' => 'Softleister\\BackupDbBundle\\SoftleisterBackupDbBundle',
                'CgoitCalendarExtendedBundle' => 'Cgoit\\CalendarExtendedBundle\\CgoitCalendarExtendedBundle',
                'ContaoDDAdvancedClassesBundle' => 'ContaoDD\\AdvancedClassesBundle\\ContaoDDAdvancedClassesBundle',
                'CodefogNewsCategoriesBundle' => 'Codefog\\NewsCategoriesBundle\\CodefogNewsCategoriesBundle',
                'CgoitLeadsOptinBundle' => 'Cgoit\\LeadsOptinBundle\\CgoitLeadsOptinBundle',
                'Terminal42NodeBundle' => 'Terminal42\\NodeBundle\\Terminal42NodeBundle',
                'ContaoEventRegistrationBundle' => 'InspiredMinds\\ContaoEventRegistration\\ContaoEventRegistrationBundle',
                'CalendarEditorBundle' => 'DanielGausi\\CalendarEditorBundle\\CalendarEditorBundle',
                'BugBusterContaoDlstatsExportBundle' => 'BugBuster\\DlstatsExportBundle\\BugBusterContaoDlstatsExportBundle',
                'CodefogTagsBundle' => 'Codefog\\TagsBundle\\CodefogTagsBundle',
                'Terminal42NewsNewsletterBundle' => 'Terminal42\\NewsNewsletterBundle\\Terminal42NewsNewsletterBundle',
                'PdirMaeEventCategoriesBundle' => 'Pdir\\MaeEventCategoriesBundle\\PdirMaeEventCategoriesBundle',
                'ContaoCommentsBundle' => 'Contao\\CommentsBundle\\ContaoCommentsBundle',
                'CgoitFormFillPdfBundle' => 'Cgoit\\FormFillPdfBundle\\CgoitFormFillPdfBundle',
                'CgoitCmaceBundle' => 'Cgoit\\CmaceBundle\\CgoitCmaceBundle',
                'ThemeComponentsBundle' => 'ContaoThemesNet\\ThemeComponentsBundle\\ThemeComponentsBundle',
                'ContaoThemesNetMateThemeBundle' => 'ContaoThemesNet\\MateThemeBundle\\ContaoThemesNetMateThemeBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'Code4NixUriSigner' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/code4nix/uri-signer'),
                ...
                'HeimseitenContaoGoogleFontsRobotoBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-roboto-bundle/src'),
                ...
                'HeimrichHannotUtilsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-utils-bundle'),
                    'namespace' => 'HeimrichHannot\\UtilsBundle',
                ],
                'TickerBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-ticker-bundle'),
                    'namespace' => 'Softleister\\TickerBundle',
                ],
                'Terminal42FolderpageBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-folderpage'),
                    'namespace' => 'Terminal42\\FolderpageBundle',
                ],
                'BweinBackendCustomizerBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bwein-net/contao-backend-customizer'),
                    'namespace' => 'Bwein\\BackendCustomizer',
                ],
                'ContaoCookiebar' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/oveleon/contao-cookiebar'),
                ...
                'Terminal42InsertTagsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-inserttags'),
                    'namespace' => 'Terminal42\\InsertTagsBundle',
                ],
                'ContaoThemesNetMaterialIconsInserttagBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/material-icons-inserttag'),
                    'namespace' => 'ContaoThemesNet\\MaterialIconsInserttag',
                ],
                'HeimseitenContaoGoogleFontsOpenSansBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-open-sans-bundle/src'),
                    'namespace' => 'Heimseiten\\ContaoGoogleFontsOpenSansBundle',
                ],
                'FileManagerBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/sineos/filemanager-bundle'),
                    'namespace' => 'Sineos\\FileManagerBundle',
                ],
                'BugBusterClientHintsRequestBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-clienthints-request-bundle'),
                    'namespace' => 'BugBuster\\ClientHintsRequestBundle',
                ],
                'SoftleisterPdfformsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-pdfforms-bundle/src'),
                    'namespace' => 'Softleister\\PdfformsBundle',
                ],
                'MarkocupicContaoBundleCreatorBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/contao-bundle-creator-bundle'),
                    'namespace' => 'Markocupic\\ContaoBundleCreatorBundle',
                ],
                'BugBusterBotdetectionBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-botdetection-bundle/src'),
                    'namespace' => 'BugBuster\\BotdetectionBundle',
                ],
                'MarkocupicContaoTwigAssets' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/contao-twig-assets'),
                    'namespace' => 'Markocupic\\ContaoTwigAssets',
                ],
                'MarkocupicGalleryCreatorBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle'),
                ...
                'DiversworldContaoCheckBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/diversworld/contao-check-bundle'),
                    'namespace' => 'Diversworld\\ContaoCheckBundle',
                ],
                'BugBusterVisitorsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-visitors-bundle/src'),
                ...
                'SoftleisterCe_be_remarksBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-ce_be_remarks/src'),
                    'namespace' => 'Softleister\\Ce_be_remarksBundle',
                ],
                'MarkocupicZipBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/zip-bundle/src'),
                    'namespace' => 'Markocupic\\ZipBundle',
                ],
                'HeimseitenContaoStickyFooterBackendBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-sticky-footer-backend-bundle/src'),
                    'namespace' => 'Heimseiten\\ContaoStickyFooterBackendBundle',
                ],
                'DiversworldContaoDucappBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/diversworld/contao-ducapp-bundle'),
                ...
                'HeimrichHannotContaoMultiColumnEditorBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src'),
                    'namespace' => 'HeimrichHannot\\MultiColumnEditorBundle',
                ],
                'MarkocupicImportFromCsvBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/import-from-csv-bundle'),
                    'namespace' => 'Markocupic\\ImportFromCsvBundle',
                ],
                'BugBusterDlstatsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-bundle/src'),
                    'namespace' => 'BugBuster\\DlstatsBundle',
                ],
                'MvoContaoGroupWidgetBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/mvo/contao-group-widget'),
                    'namespace' => 'Mvo\\ContaoGroupWidget',
                ],
                'HeimrichHannotContaoAjaxBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-ajax-bundle/src'),
                    'namespace' => 'HeimrichHannot\\AjaxBundle',
                ],
                'ThemeHelperBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-theme-helper-bundle'),
                    'namespace' => 'Pdir\\ThemeHelperBundle',
                ],
                'PdirContaoStickyFooterBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-sticky-footer/src'),
                    'namespace' => 'Pdir\\ContaoStickyFooterBundle',
                ],
                'MarkocupicBackendPasswordRecoveryBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle'),
                ...
                'TastaturberufContaoImageCopyrightBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/tastaturberuf/contao-image-copyright-bundle'),
                    'namespace' => 'Tastaturberuf\\ContaoImageCopyrightBundle',
                ],
                'Terminal42PageimageBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-pageimage'),
                    'namespace' => 'Terminal42\\PageimageBundle',
                ],
                'Terminal42ConditionalSelectMenuBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalselectmenu'),
                    'namespace' => 'Terminal42\\ConditionalSelectMenuBundle',
                ],
                'ContaoBackendFormsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-backend-forms/src'),
                    'namespace' => 'InspiredMinds\\ContaoBackendFormsBundle',
                ],
                'Terminal42LeadsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-leads'),
                ...
                'PdirContaoWebtoolsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-webtools'),
                ...
                'MarkocupicContaoAltchaAntispam' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/markocupic/contao-altcha-antispam'),
                ...
                'ProperFilenamesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/numero2/contao-proper-filenames/src'),
                    'namespace' => 'numero2\\ProperFilenamesBundle',
                ],
                'SoftleisterBackupDbBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-backupdb-bundle/src'),
                    'namespace' => 'Softleister\\BackupDbBundle',
                ],
                'CgoitCalendarExtendedBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/cgoit/calendar-extended-bundle'),
                    'namespace' => 'Cgoit\\CalendarExtendedBundle',
                ],
                'ContaoDDAdvancedClassesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/contao-dd/advanced-classes-bundle'),
                    'namespace' => 'ContaoDD\\AdvancedClassesBundle',
                ],
                'CodefogNewsCategoriesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/codefog/contao-news_categories'),
                    'namespace' => 'Codefog\\NewsCategoriesBundle',
                ],
                'CgoitLeadsOptinBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-leads-optin-bundle'),
                    'namespace' => 'Cgoit\\LeadsOptinBundle',
                ],
                'Terminal42NodeBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-node'),
                    'namespace' => 'Terminal42\\NodeBundle',
                ],
                'ContaoEventRegistrationBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration'),
                    'namespace' => 'InspiredMinds\\ContaoEventRegistration',
                ],
                'CalendarEditorBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/danielgausi/contao-calendareditor-bundle/src'),
                    'namespace' => 'DanielGausi\\CalendarEditorBundle',
                ],
                'BugBusterContaoDlstatsExportBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src'),
                    'namespace' => 'BugBuster\\DlstatsExportBundle',
                ],
                'CodefogTagsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/codefog/tags-bundle/src'),
                    'namespace' => 'Codefog\\TagsBundle',
                ],
                'Terminal42NewsNewsletterBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-news_newsletter'),
                    'namespace' => 'Terminal42\\NewsNewsletterBundle',
                ],
                'PdirMaeEventCategoriesBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/marebe1602/mae_event_categories'),
                ...
                'CgoitFormFillPdfBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-form-fill-pdf-bundle'),
                    'namespace' => 'Cgoit\\FormFillPdfBundle',
                ],
                'CgoitCmaceBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-cmace-bundle'),
                    'namespace' => 'Cgoit\\CmaceBundle',
                ],
                'ThemeComponentsBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/theme-components-bundle'),
                    'namespace' => 'ContaoThemesNet\\ThemeComponentsBundle',
                ],
                'ContaoThemesNetMateThemeBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/mate-theme-bundle'),
            ...
            'code4nix_uri_signer.parameter' => '_hash',
            'code4nix_uri_signer.expiration' => 3600,
            ...
            'contao.localconfig' => [
                'pdfformsLicence' => '1SORN-ZKEKO-9DRTP-L9E0C',
            ],
            ...
            'contao_cookiebar.consider_dnt' => false,
            'contao_cookiebar.anonymize_ip' => false,
            'contao_cookiebar.consent_log' => false,
            'contao_cookiebar.lifetime' => 63072000,
            'contao_cookiebar.storage_key' => 'ccb_contao_token',
            'contao_cookiebar.iframe_types' => [
                'youtube' => [
                    0 => 'ce_youtube',
                    1 => 'youtube',
                ],
                ...
                'googlemaps' => [
                    0 => 'ce_html_googlemaps',
                    1 => 'mod_html_googlemaps',
                    2 => 'content_element/html/googlemaps',
                    3 => 'content_element/unfiltered_html/googlemaps',
                    4 => 'frontend_module/unfiltered_html/googlemaps',
                ],
                'openstreetmap' => [
                    0 => 'ce_html_openstreetmap',
                    1 => 'mod_html_openstreetmap',
                    2 => 'content_element/html/openstreetmap',
                    3 => 'content_element/unfiltered_html/openstreetmap',
                    4 => 'frontend_module/unfiltered_html/openstreetmap',
                ],
            ],
            'contao_cookiebar.page_templates' => [
                0 => 'fe_page',
            ],
            'contao_cookiebar.disable_focustrap' => false,
            'markocupic_gallery_creator.upload_path' => 'files/gallery_creator_albums',
            'markocupic_gallery_creator.copy_images_on_import' => true,
            'markocupic_gallery_creator.read_exif_meta_data' => false,
            'markocupic_gallery_creator.valid_extensions' => [
                0 => 'jpg',
                1 => 'jpeg',
                2 => 'gif',
                3 => 'png',
            ...
            'diversworld_contao_check.foo.bar' => '***',
            'diversworld_contao_ducapp.foo.bar' => '***',
            'markocupic_import_from_csv.max_inserts_per_request' => 25,
            'markocupic_backend_password_recovery.token_lifetime' => 600,
            'markocupic_backend_password_recovery.show_password_recovery_link_on_login_failure_only' => true,
            'markocupic_contao_altcha_antispam.hmac_key' => '',
            'markocupic_contao_altcha_antispam.algorithm' => 'SHA-256',
            'markocupic_contao_altcha_antispam.range_min' => 10000,
            'markocupic_contao_altcha_antispam.range_max' => 100000,
            'markocupic_contao_altcha_antispam.challenge_expiry' => 3600,
            'cgoit_calendar_extended.max_repeat_count' => 365,
            'cgoit_calendar_extended.filter_fields' => [
                0 => 'title',
                1 => 'location_name',
                2 => 'location_str',
                3 => 'location_plz',
            ],
            'cgoit_calendar_extended.exceptions.max_count' => 250,
            'cgoit_calendar_extended.exceptions.move_days' => 7,
            'cgoit_calendar_extended.exceptions.move_times' => [
                'from' => '00:00',
                'to' => '23:59',
                'interval' => 15,
            ],
            'contao_event_registration.tokens.supported_notifications' => [
                0 => 'core_form',
                1 => 'event_registration_confirm',
                2 => 'event_registration_cancel',
                3 => 'event_registration_waiting_list_advancement',
            ],
            ...
            'contao.resources_paths' => [
                ...
                'HeimseitenContaoGoogleFontsRobotoBundle' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-roboto-bundle/src/Resources/contao'),
                'Terminal42ConditionalformfieldsBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalformfields/contao'),
                'TickerBundle' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-ticker-bundle/contao'),
                'Terminal42FolderpageBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-folderpage/contao'),
                'ContaoCookiebar' => (\dirname(__DIR__, 4).'/vendor/oveleon/contao-cookiebar/contao'),
                'MultiColumnWizardBundle' => (\dirname(__DIR__, 4).'/vendor/menatwork/contao-multicolumnwizard-bundle/src/Resources/contao'),
                'Terminal42InsertTagsBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-inserttags/contao'),
                'ContaoThemesNetMaterialIconsInserttagBundle' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/material-icons-inserttag/contao'),
                'HeimseitenContaoGoogleFontsOpenSansBundle' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-google-fonts-open-sans-bundle/src/Resources/contao'),
                'FileManagerBundle' => (\dirname(__DIR__, 4).'/vendor/sineos/filemanager-bundle/contao'),
                'SoftleisterPdfformsBundle' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-pdfforms-bundle/src/Resources/contao'),
                'MarkocupicContaoBundleCreatorBundle' => (\dirname(__DIR__, 4).'/vendor/markocupic/contao-bundle-creator-bundle/contao'),
                'BugBusterBotdetectionBundle' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-botdetection-bundle/src/Resources/contao'),
                'MarkocupicGalleryCreatorBundle' => (\dirname(__DIR__, 4).'/vendor/markocupic/gallery-creator-bundle/contao'),
                'ContaoFaqBundle' => (\dirname(__DIR__, 4).'/vendor/contao/faq-bundle/contao'),
                'DiversworldContaoCheckBundle' => (\dirname(__DIR__, 4).'/vendor/diversworld/contao-check-bundle/contao'),
                'BugBusterVisitorsBundle' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-visitors-bundle/src/Resources/contao'),
                'CodefogHasteBundle' => (\dirname(__DIR__, 4).'/vendor/codefog/contao-haste/contao'),
                'SoftleisterCe_be_remarksBundle' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-ce_be_remarks/src/Resources/contao'),
                'HeimseitenContaoStickyFooterBackendBundle' => (\dirname(__DIR__, 4).'/vendor/heimseiten/contao-sticky-footer-backend-bundle/src/Resources/contao'),
                'DiversworldContaoDucappBundle' => (\dirname(__DIR__, 4).'/vendor/diversworld/contao-ducapp-bundle/contao'),
                'Terminal42DcawizardBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/dcawizard/contao'),
                'HeimrichHannotContaoMultiColumnEditorBundle' => (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-multi-column-editor-bundle/src/Resources/contao'),
                'MarkocupicImportFromCsvBundle' => (\dirname(__DIR__, 4).'/vendor/markocupic/import-from-csv-bundle/contao'),
                'BugBusterDlstatsBundle' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-bundle/src/Resources/contao'),
                'HeimrichHannotContaoAjaxBundle' => (\dirname(__DIR__, 4).'/vendor/heimrichhannot/contao-ajax-bundle/src/Resources/contao'),
                'ThemeHelperBundle' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-theme-helper-bundle/contao'),
                'PdirContaoStickyFooterBundle' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-sticky-footer/src/Resources/contao'),
                'MarkocupicBackendPasswordRecoveryBundle' => (\dirname(__DIR__, 4).'/vendor/markocupic/backend-password-recovery-bundle/contao'),
                'ContaoNewsBundle' => (\dirname(__DIR__, 4).'/vendor/contao/news-bundle/contao'),
                'TastaturberufContaoImageCopyrightBundle' => (\dirname(__DIR__, 4).'/vendor/tastaturberuf/contao-image-copyright-bundle/Resources/contao'),
                'Terminal42PageimageBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-pageimage/contao'),
                'Terminal42ConditionalSelectMenuBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-conditionalselectmenu/contao'),
                'ContaoBackendFormsBundle' => (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-backend-forms/src/Resources/contao'),
                'Terminal42LeadsBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-leads/contao'),
                'ContaoListingBundle' => (\dirname(__DIR__, 4).'/vendor/contao/listing-bundle/contao'),
                'PdirContaoWebtoolsBundle' => (\dirname(__DIR__, 4).'/vendor/pdir/contao-webtools/contao'),
                'Terminal42NotificationCenterBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/notification_center/contao'),
                'ContaoCalendarBundle' => (\dirname(__DIR__, 4).'/vendor/contao/calendar-bundle/contao'),
                'MarkocupicContaoAltchaAntispam' => (\dirname(__DIR__, 4).'/vendor/markocupic/contao-altcha-antispam/contao'),
                'ContaoNewsletterBundle' => (\dirname(__DIR__, 4).'/vendor/contao/newsletter-bundle/contao'),
                'ProperFilenamesBundle' => (\dirname(__DIR__, 4).'/vendor/numero2/contao-proper-filenames/src/Resources/contao'),
                'SoftleisterBackupDbBundle' => (\dirname(__DIR__, 4).'/vendor/do-while/contao-backupdb-bundle/src/Resources/contao'),
                'CgoitCalendarExtendedBundle' => (\dirname(__DIR__, 4).'/vendor/cgoit/calendar-extended-bundle/contao'),
                'ContaoDDAdvancedClassesBundle' => (\dirname(__DIR__, 4).'/vendor/contao-dd/advanced-classes-bundle/contao'),
                'CodefogNewsCategoriesBundle' => (\dirname(__DIR__, 4).'/vendor/codefog/contao-news_categories/contao'),
                'CgoitLeadsOptinBundle' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-leads-optin-bundle/contao'),
                'Terminal42NodeBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-node/contao'),
                'ContaoEventRegistrationBundle' => (\dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/contao'),
                'CalendarEditorBundle' => (\dirname(__DIR__, 4).'/vendor/danielgausi/contao-calendareditor-bundle/src/Resources/contao'),
                'BugBusterContaoDlstatsExportBundle' => (\dirname(__DIR__, 4).'/vendor/bugbuster/contao-dlstats-statistic-export-bundle/src/Resources/contao'),
                'CodefogTagsBundle' => (\dirname(__DIR__, 4).'/vendor/codefog/tags-bundle/src/Resources/contao'),
                'Terminal42NewsNewsletterBundle' => (\dirname(__DIR__, 4).'/vendor/terminal42/contao-news_newsletter/contao'),
                'PdirMaeEventCategoriesBundle' => (\dirname(__DIR__, 4).'/vendor/marebe1602/mae_event_categories/contao'),
                'ContaoCommentsBundle' => (\dirname(__DIR__, 4).'/vendor/contao/comments-bundle/contao'),
                'CgoitFormFillPdfBundle' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-form-fill-pdf-bundle/contao'),
                'CgoitCmaceBundle' => (\dirname(__DIR__, 4).'/vendor/cgoit/contao-cmace-bundle/contao'),
                'ThemeComponentsBundle' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/theme-components-bundle/contao'),
                'ContaoThemesNetMateThemeBundle' => (\dirname(__DIR__, 4).'/vendor/contao-themes-net/mate-theme-bundle/contao'),
            ],
            'console.command.ids' => [
