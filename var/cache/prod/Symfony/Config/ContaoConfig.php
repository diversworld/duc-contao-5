...
class ContaoConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    /**
     * @default {"bypass_cache":false,"imagine_options":{"jpeg_quality":80,"jpeg_sampling_factors":[2,1,1],"interlace":"plane"},"imagine_service":null,"reject_large_uploads":false,"sizes":[],"target_dir":"\/shared\/httpd\/duc-contao-5\/assets\/images","target_path":null,"valid_extensions":["jpg","jpeg","gif","png","tif","tiff","bmp","svg","svgz","webp","avif"],"preview":{"target_dir":"\/shared\/httpd\/duc-contao-5\/assets\/previews","default_size":512,"max_size":1024,"enable_fallback_images":true},"preserve_metadata_fields":{"xmp":{"http:\/\/purl.org\/dc\/elements\/1.1\/":["rights","creator"],"http:\/\/ns.adobe.com\/photoshop\/1.0\/":["Source","Credit"]},"iptc":["2#116","2#080","2#115","2#110"],"exif":{"IFD0":["Copyright","Artist"]},"png":["Copyright","Author","Source","Disclaimer"],"gif":["Comment"]}}
    */
