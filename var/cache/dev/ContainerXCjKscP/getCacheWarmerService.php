...
class getCacheWarmerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 7 => ($container->services['contao.cache.warmer'] ?? $container->load('getContao_Cache_WarmerService'));
            yield 8 => ($container->privates['contao.doctrine.orm.fail_tolerant_proxy_cache_warmer'] ?? $container->load('getContao_Doctrine_Orm_FailTolerantProxyCacheWarmerService'));
            yield 9 => ($container->privates['contao.twig.filesystem_loader_warmer'] ?? $container->load('getContao_Twig_FilesystemLoaderWarmerService'));
        }, 10), true, ($container->targetDir.''.'/Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainerDeprecations.log'));
    }
}
