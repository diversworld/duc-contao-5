...
// vendor/bugbuster/contao-visitors-bundle/src/Resources/contao/languages/de/tl_visitors.xlf
...
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_checks']['1'] = 'Bei Aktivierung werden Laufzeitinformationen (visitors.DEBUG) in die Logdatei (<em>var/logs/prod-Datum.log</em>) geschrieben.';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_referrer']['0'] = 'Debugmodus für die Klasse "Visitor Referrer"';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_referrer']['1'] = 'Bei Aktivierung werden Laufzeitinformationen (visitors.DEBUG) in die Logdatei (<em>var/logs/prod-Datum.log</em>) geschrieben.';
...
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_screenresolutioncount']['1'] = 'Bei Aktivierung werden Laufzeitinformationen (visitors.DEBUG) in die Logdatei (<em>var/logs/prod-Datum.log</em>) geschrieben.';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_searchengine']['0'] = 'Debugmodus für die Klasse "Visitor SearchEngine"';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_searchengine']['1'] = 'Bei Aktivierung werden Laufzeitinformationen (visitors.DEBUG) in die Logdatei (<em>var/logs/prod-Datum.log</em>) geschrieben.';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_tag']['0'] = 'Debugmodus für die Klasse "Visitors Tag"';
$GLOBALS['TL_LANG']['tl_visitors']['visitors_expert_debug_tag']['1'] = 'Bei Aktivierung werden Laufzeitinformationen (visitors.DEBUG) in die Logdatei (<em>var/logs/prod-Datum.log</em>) geschrieben.';
