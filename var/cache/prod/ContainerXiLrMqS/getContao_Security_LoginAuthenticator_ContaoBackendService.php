...
class getContao_Security_LoginAuthenticator_ContaoBackendService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $j = new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallConfig(['remember_me' => false, 'require_previous_session' => false, 'auth_code_parameter_name' => 'verify'], 'contao_backend', $e, ($container->privates['scheb_two_factor.security.request_data_reader'] ??= new \Scheb\TwoFactorBundle\Security\Http\Utils\RequestDataReader()));

        return $container->privates['contao.security.login_authenticator.contao_backend'] = new \Contao\CoreBundle\Security\Authenticator\ContaoLoginAuthenticator(($container->privates['contao.security.backend_user_provider'] ?? $container->load('getContao_Security_BackendUserProviderService')), $a, $h, ($container->services['contao.routing.scope_matcher'] ?? self::getContao_Routing_ScopeMatcherService($container)), ($container->privates['router.default'] ?? self::getRouter_DefaultService($container)), ($container->services['uri_signer'] ??= new \Symfony\Component\HttpFoundation\UriSigner($container->getEnv('APP_SECRET'))), $b, $i, $c, $d, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Scheb\TwoFactorBundle\Security\Http\Authenticator\TwoFactorAuthenticator($j, $i, $a, $h, new \Scheb\TwoFactorBundle\Security\Http\Authentication\DefaultAuthenticationRequiredHandler($e, $j), $f, $g), ['require_previous_session' => false, 'auth_code_parameter_name' => 'verify']);
    }
}
