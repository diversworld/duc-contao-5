...
// vendor/contao/core-bundle/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['ERR']['general'] = 'Ein Fehler ist aufgetreten!';
$GLOBALS['TL_LANG']['ERR']['submit'] = 'Die Daten konnten nicht gespeichert werden, weil ein Fehler aufgetreten ist!';
...
$GLOBALS['TL_LANG']['ERR']['tooManyLoginAttempts'] = 'Zu viele fehlgeschlagene Anmeldeversuche, bitte versuchen Sie es später noch einmal.';
...
$GLOBALS['TL_LANG']['ERR']['urlPrefixExists'] = 'Das URL-Präfix "%s" wird bereits von einem anderen Website-Startpunkt mit demselben Domainnamen verwendet!';
...
$GLOBALS['TL_LANG']['ERR']['topLevelRegular'] = 'Es sind Seiten in der obersten Ebene, die keine Website-Startpunkte sind.';
...
$GLOBALS['TL_LANG']['ERR']['startStop'] = 'Die Endzeit muss nach der Anfangszeit liegen.';
$GLOBALS['TL_LANG']['ERR']['noAdminEmailUrl'] = 'Es ist keine Administrator-E-Mail-Adresse in den <a href="%s" target="_top">System-Einstellungen</a> hinterlegt.';
$GLOBALS['TL_LANG']['ERR']['noAdminEmail'] = 'Es ist keine Administrator-E-Mail-Adresse hinterlegt. Bitte wenden Sie sich an den Administrator der Webseite.';
$GLOBALS['TL_LANG']['ERR']['personalDataPassword'] = 'Es gibt mindestens ein Modul "Personendaten", das die Änderung des Passworts erlaubt. Das ist eine Sicherheitsschwachstelle und wird in Contao 6 nicht mehr funktionieren. Verwenden Sie stattdessen das Modul "Passwort ändern".';
...
$GLOBALS['TL_LANG']['CTE']['unfiltered_html']['0'] = 'Ungefiltertes HTML';
$GLOBALS['TL_LANG']['CTE']['unfiltered_html']['1'] = 'Erlaubt das Hinzufügen von eigenem, ungefiltertem HTML-Code.';
$GLOBALS['TL_LANG']['CTE']['list']['0'] = 'Aufzählung';
$GLOBALS['TL_LANG']['CTE']['list']['1'] = 'Erzeugt eine geordnete oder ungeordnete Liste.';
$GLOBALS['TL_LANG']['CTE']['description_list']['0'] = 'Beschreibungsliste';
$GLOBALS['TL_LANG']['CTE']['description_list']['1'] = 'Generiert eine Beschreibungsliste mit Begriffen und Details.';
...
$GLOBALS['TL_LANG']['CTE']['accordion']['1'] = 'Erzeugt ein Akkordeon.';
$GLOBALS['TL_LANG']['CTE']['element_group']['0'] = 'Elementgruppe';
$GLOBALS['TL_LANG']['CTE']['element_group']['1'] = 'Erzeugt eine Gruppe verschachtelter Elemente.';
$GLOBALS['TL_LANG']['CTE']['accordionStart']['0'] = 'Akkordeon Umschlag Anfang';
$GLOBALS['TL_LANG']['CTE']['accordionStart']['1'] = 'Erzeugt den öffnenden Teil des Akkordeon-Umschlags.';
$GLOBALS['TL_LANG']['CTE']['accordionStop']['0'] = 'Akkordeon Umschlag Ende';
$GLOBALS['TL_LANG']['CTE']['accordionStop']['1'] = 'Erzeugt den schließenden Teil des Akkordeon-Umschlags.';
$GLOBALS['TL_LANG']['CTE']['accordionSingle']['0'] = 'Akkordeon Einzelelement';
...
$GLOBALS['TL_LANG']['CTE']['swiper']['1'] = 'Erzeugt ein Content-Slider-Element.';
$GLOBALS['TL_LANG']['CTE']['slider'] = 'Content-Slider';
$GLOBALS['TL_LANG']['CTE']['sliderStart']['0'] = 'Slider Umschlag Anfang';
$GLOBALS['TL_LANG']['CTE']['sliderStart']['1'] = 'Erzeugt den öffnenden Teil des Slider-Umschlags.';
$GLOBALS['TL_LANG']['CTE']['sliderStop']['0'] = 'Slider Umschlag Ende';
...
$GLOBALS['TL_LANG']['CTE']['legacy'] = 'Legacy-Elemente';
...
$GLOBALS['TL_LANG']['PTY']['forward']['1'] = 'Dieser Seitentyp leitet Besucher automatisch zu einer anderen Seite weiter.';
$GLOBALS['TL_LANG']['PTY']['root']['0'] = 'Startpunkt einer Webseite';
$GLOBALS['TL_LANG']['PTY']['root']['1'] = 'Dieser Seitentyp kennzeichnet den Startpunkt einer neuen Webseite.';
...
$GLOBALS['TL_LANG']['PTY']['error_503']['1'] = 'Wenn sich ein Website-Startpunkt im Wartungsmodus befindet, wird für alle Anfragen eine 503-Fehlerseite angezeigt.';
...
$GLOBALS['TL_LANG']['MSC']['aw_caption'] = 'Untertitel';
...
$GLOBALS['TL_LANG']['MSC']['custom']['0'] = 'Eigene Größen';
$GLOBALS['TL_LANG']['MSC']['custom']['1'] = 'Das Bild wird an die vorgegebenen Abmessungen angepasst.';
...
$GLOBALS['TL_LANG']['MSC']['crop']['0'] = 'Exaktes Format (wichtiger Teil)';
$GLOBALS['TL_LANG']['MSC']['crop']['1'] = 'Erhält den wichtigen Teil des Bildes wie in der Dateiverwaltung angegeben. Falls erforderlich, wird das Bild beschnitten.';
...
$GLOBALS['TL_LANG']['MSC']['saveNedit'] = 'Speichern und Kindelemente bearbeiten';
...
$GLOBALS['TL_LANG']['MSC']['imageMetadata'] = '%s-Metadaten';
...
$GLOBALS['TL_LANG']['MSC']['copyMultiple'] = 'Mehrfach kopieren';
...
$GLOBALS['TL_LANG']['MSC']['guests'] = 'Gäste (nicht angemeldet)';
...
$GLOBALS['TL_LANG']['MSC']['lostPassword'] = 'Passwort vergessen?';
...
$GLOBALS['TL_LANG']['MSC']['reauthenticate'] = 'Bitte geben Sie Ihr Passwort ein, um Ihre Identität zu bestätigen.';
$GLOBALS['TL_LANG']['MSC']['verify'] = 'Bestätigen';
...
$GLOBALS['TL_LANG']['MSC']['twitterShare'] = 'Auf X (vormals Twitter) teilen';
...
$GLOBALS['TL_LANG']['MSC']['metaNoLanguages'] = 'Sie müssen einen Website-Startpunkt anlegen, um Metadaten einzugeben.';
...
$GLOBALS['TL_LANG']['MSC']['favorites'] = 'Favoriten';
$GLOBALS['TL_LANG']['MSC']['favorite'] = 'URL als Favorit speichern';
$GLOBALS['TL_LANG']['MSC']['editFavorites'] = 'Favoriten bearbeiten';
...
$GLOBALS['TL_LANG']['MSC']['groupUnfilteredHtml'] = 'Mindestens eine Benutzergruppe gewährt Zugriff auf das ungefilterte HTML-Element. Da der HTML-Code dieses Elements nicht gefiltert wird, haben die Benutzer dieser Gruppen implizit die volle Kontrolle über das System!';
$GLOBALS['TL_LANG']['MSC']['userUnfilteredHtml'] = 'Mindestens ein regulärer Benutzer hat Zugriff auf das ungefilterte HTML-Element. Da der HTML-Code dieses Elements nicht gefiltert wird, haben diese Benutzer implizit die volle Kontrolle über das System!';
...
$GLOBALS['TL_LANG']['MSC']['splashScreen'] = 'Bitte klicken, um das Video zu laden.';
$GLOBALS['TL_LANG']['MSC']['dataTransmission'] = 'Ihre IP-Adresse wird an %s übermittelt.';
$GLOBALS['TL_LANG']['MSC']['showFrom'] = 'sichtbar ab %s';
$GLOBALS['TL_LANG']['MSC']['showTo'] = 'sichtbar bis %s';
$GLOBALS['TL_LANG']['MSC']['showFromTo'] = 'sichtbar von %s bis %s';
$GLOBALS['TL_LANG']['MSC']['editImageSize'] = 'Die Bildgröße bearbeiten';
$GLOBALS['TL_LANG']['MSC']['booleanNot'] = 'Nicht %s';
$GLOBALS['TL_LANG']['MSC']['darkMode'] = 'Dunkles Design';
$GLOBALS['TL_LANG']['MSC']['lightMode'] = 'Helles Design';
...
$GLOBALS['TL_LANG']['DCA']['children'] = 'Kindelemente des Elements ID %s bearbeiten';
$GLOBALS['TL_LANG']['DCA']['toggle']['0'] = 'Element veröffentlichen/unveröffentlichen';
$GLOBALS['TL_LANG']['DCA']['toggle']['1'] = 'Element ID %s unveröffentlichen';
$GLOBALS['TL_LANG']['DCA']['toggle']['2'] = 'Element ID %s veröffentlichen';
...
// vendor/oveleon/contao-cookiebar/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['CTE']['cookiebar_opener']['0'] = 'Cookiebar (Link zum Öffnen)';
$GLOBALS['TL_LANG']['CTE']['cookiebar_opener']['1'] = 'Erzeugt einen Link, der die Cookiebar anzeigt';
...
$GLOBALS['TL_LANG']['sineos_filemanager']['back'] = 'Zurück';

// vendor/markocupic/contao-bundle-creator-bundle/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['ERR']['cbcb_rgxp'] = 'Ungültige Eingabe! Bitte verwenden Sie "%s" anstatt "%s".';
 ...
 */
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_agent'] = 'User Agent Kennung';
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_captcha'] = 'Sicherheitsfrage';
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_found'] = 'User Agent als Bot ist bekannt.';
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_message_1'] = 'Test für User Agent';
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_not'] = 'User Agent als Bot unbekannt.';
$GLOBALS['TL_LANG']['MSC']['botdetectiondemo2_submit'] = 'Senden';

// vendor/markocupic/gallery-creator-bundle/contao/languages/de/default.xlf
...
$GLOBALS['TL_LANG']['ERR']['dirNotWriteable'] = 'Das Verzeichnis "%s" ist nicht beschreibbar. Bitte überprüfen Sie die CHMOD-Einstellungen.';
...
$GLOBALS['TL_LANG']['ERR']['rotateImageError'] = 'Beim Versuch das Bild "%s" zu drehen, ist es zu einem Fehler gekommen.';
$GLOBALS['TL_LANG']['MSC']['useFileUploadForCreatingNewPicture'] = 'Benutzen Sie den "Bilder hochladen" Button um ein neues Bild zu erstellen.';
$GLOBALS['TL_LANG']['MSC']['notAllowedEditAlbum'] = 'Sie haben nicht die erforderlichen Rechte, das Album "%s" zu bearbeiten.';
$GLOBALS['TL_LANG']['MSC']['notAllowedDeleteAlbum'] = 'Sie haben nicht die erforderlichen Rechte, um das Album mit ID %d zu löschen.';
$GLOBALS['TL_LANG']['MSC']['notAllowedMoveAlbum'] = 'Sie haben nicht die erforderlichen Rechte, um das Album mit ID %d zu verschieben.';
$GLOBALS['TL_LANG']['MSC']['notAllowedAddChildAlbum'] = 'Sie haben nicht die erforderlichen Rechte, um innerhalb des Albums mit ID %d Unteralben zu erstellen.';
$GLOBALS['TL_LANG']['MSC']['notAllowedEditPictures'] = 'Sie haben nicht die erforderlichen Rechte, um das Bild mit ID %d zu bearbeiten.';
$GLOBALS['TL_LANG']['MSC']['notAllowedDeletePictures'] = 'Sie haben nicht die erforderlichen Rechte, um innerhalb des Albums mit ID %d Bilder zu löschen.';
$GLOBALS['TL_LANG']['MSC']['notAllowedAddPictures'] = 'Sie haben nicht die erforderlichen Rechte, um dem Album mit ID %d Bilder hinzuzufügen.';
$GLOBALS['TL_LANG']['MSC']['notAllowedMovePictures'] = 'Sie haben nicht die erforderlichen Rechte, um innerhalb des Albums mit ID %d Bilder zu verschieben.';
$GLOBALS['TL_LANG']['CONFIRM']['gcDeleteConfirmAlbum'] = 'Soll das Album mit der ID %s gelöscht werden? Achtung. Dadurch werden auch alle Bilddateien im zugeordneten Verzeichnis gelöscht.';
$GLOBALS['TL_LANG']['CONFIRM']['gcDeleteConfirmPicture'] = 'Soll das Bild mit der ID %s gelöscht werden? Achtung. Dabei wird auch die Bilddatei aus dem Dateisystem entfernt.';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['backLink'] = 'zurück';
...
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthenticationError']['0'] = 'Authentifizierungsfehler';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthenticationError']['1'] = 'Der Zugriff auf dieses Album wurde verweigert. Bitte melden Sie sich als Frontend-User an oder überprüfen Sie Ihre Benutzerrechte.';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['photographerName'] = 'Fotograf';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['location'] = 'Location';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['selectAllAlbums'] = 'Alle Alben auswählen';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['localMedia'] = 'Ersetze das Bild mit einer Video- oder Tondatei aus dem Contao Dateisystem.';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['socialMedia'] = 'Ersetze das Bild mit Inhalt von einer Social Media Plattform.';
$GLOBALS['TL_LANG']['CHMOD']['gcDefaultChmod'] = 'Gallery Creator Standard Zugriffsrechte';
$GLOBALS['TL_LANG']['CHMOD']['editalbum'] = 'Album bearbeiten';
$GLOBALS['TL_LANG']['CHMOD']['addchildalbums'] = 'Unteralben hinzufügen';
$GLOBALS['TL_LANG']['CHMOD']['deletealbum'] = 'Album löschen';
$GLOBALS['TL_LANG']['CHMOD']['movealbum'] = 'Album verschieben';
$GLOBALS['TL_LANG']['CHMOD']['addandeditimages'] = 'Bilder hinzufügen und bearbeiten';
$GLOBALS['TL_LANG']['CHMOD']['deleteimages'] = 'Bilder löschen';
$GLOBALS['TL_LANG']['CHMOD']['moveimages'] = 'Bilder verschieben';

// vendor/contao/faq-bundle/contao/languages/de/default.xlf
...
// vendor/bugbuster/contao-visitors-bundle/src/Resources/contao/languages/de/default.xlf
 ...
 * Miscellaneous
 */
$GLOBALS['TL_LANG']['CTE']['be_remarks'] = ['Backend Hinweise', 'Contentelement für Bemerkungen und Anweisungen an Redakteure, usw. Das Contentelement erzeugt KEINE Ausgabe im Frontend.'];
/**
 * Form fields
 */
$GLOBALS['TL_LANG']['FFL']['be_remarks'] = ['Backend Hinweise', 'Formularelement für Bemerkungen und Anweisungen an Redakteure, usw. Das Formularelement erzeugt KEINE Ausgabe im Frontend.'];
...
// vendor/contao/news-bundle/contao/languages/de/default.xlf
...
$GLOBALS['TL_LANG']['PTY']['news_feed']['0'] = 'News-Feed';
$GLOBALS['TL_LANG']['PTY']['news_feed']['1'] = 'Erstellen Sie einen RSS-, Atom- oder JSON-Feed aus Ihren Nachrichtenarchiven.';

$GLOBALS['TL_LANG'][\Tastaturberuf\ContaoImageCopyrightBundle\Controller\ImageCopyrightListController::TYPE] = ['ic_no_files_found' => 'Keine Bilder mit Copyright-Vermerken gefunden.'];

$GLOBALS['TL_LANG']['MSC']['purge'] = 'Purge Scripts (assets/css)';
# Disable "Kopie" when duplicating
$GLOBALS['TL_LANG']['MSC']['copyOf'] = '%s';

// vendor/terminal42/notification_center/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['NC']['before'] = 'Vorher';
$GLOBALS['TL_LANG']['NC']['after'] = 'Nachher';

// vendor/contao/calendar-bundle/contao/languages/de/default.xlf
 ...
 * Form fields
 */
$GLOBALS['TL_LANG']['FFL']['altcha_hidden'] = ['Altcha Antispam (CAPTCHA)', 'Stellt ein <a href="https://altcha.org/" title="altcha.org">ALTCHA</a> Antispam-Formularfeld zur Verfügung, um zu überprüfen, ob das Formular von einem Menschen abgesendet wird (CAPTCHA).'];
/*
 * Errors
 */
...
// vendor/contao/newsletter-bundle/contao/languages/de/default.xlf
...
// vendor/numero2/contao-proper-filenames/src/Resources/contao/languages/de/default.xlf
$GLOBALS['TL_LANG']['MSC']['proper_filenames_renamed'] = 'Die Datei „%s” wurde umbenannt zu %s”';
$GLOBALS['TL_LANG']['ERR']['proper_filenames_not_configured'] = 'Die Überprüfung von Dateinamen auf Sonderzeichen wurde aktiviert, es wurden aber noch keine gültigen Zeichen konfiguriert. <a href="%s?do=settings#sub_checkFilenames">Jetzt konfigurieren</a>';
...
// vendor/contao-dd/advanced-classes-bundle/contao/languages/de/default.xlf
...
$GLOBALS['TL_LANG']['tl_form']['advanced_classes_legend'] = 'Erweiterte CSS-Klassen';
$GLOBALS['TL_LANG']['tl_form_field']['advanced_classes_legend'] = 'Erweiterte CSS-Klassen';
...
$GLOBALS['TL_LANG']['tl_content']['advancedCss']['noConfigMessage'] = 'Keine Konfiguration gefunden.';
