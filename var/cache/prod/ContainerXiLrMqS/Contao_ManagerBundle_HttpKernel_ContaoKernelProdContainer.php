...
class Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer extends Container
{
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VlMgU+nTf-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7-cX5Pd3pe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $f = ($container->services['knp_menu.matcher'] ?? self::getKnpMenu_MatcherService($container));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension(($container->services['security.authorization_checker'] ?? self::getSecurity_AuthorizationCheckerService($container)), new \Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator($c, ($container->services['security.firewall.map'] ?? self::getSecurity_Firewall_MapService($container)), $d)));
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zpLXuIp9B2', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kRkrl3Qnul', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSecurity_Access_DecisionManagerService($container)
    {
        ...
        return $container->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 5 => ($container->privates['Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter'] ?? $container->load('getBackendAccessVoterService'));
            yield 6 => ($container->privates['contao.security.backend_access_voter'] ?? $container->load('getContao_Security_BackendAccessVoterService'));
            yield 7 => ($container->privates['contao.security.data_container.article_content_voter'] ?? $container->load('getContao_Security_DataContainer_ArticleContentVoterService'));
            yield 8 => ($container->privates['contao.security.data_container.content_composition_voter'] ?? $container->load('getContao_Security_DataContainer_ContentCompositionVoterService'));
            yield 9 => ($container->privates['contao.security.data_container.content_element_nesting_voter'] ?? $container->load('getContao_Security_DataContainer_ContentElementNestingVoterService'));
            yield 10 => ($container->privates['contao.security.data_container.content_element_type_voter'] ?? $container->load('getContao_Security_DataContainer_ContentElementTypeVoterService'));
            yield 11 => ($container->privates['contao.security.data_container.favorites_voter'] ??= new \Contao\CoreBundle\Security\Voter\DataContainer\FavoritesVoter());
            yield 12 => ($container->privates['contao.security.data_container.form_access_voter'] ?? $container->load('getContao_Security_DataContainer_FormAccessVoterService'));
            yield 13 => ($container->privates['contao.security.data_container.form_field_access_voter'] ?? $container->load('getContao_Security_DataContainer_FormFieldAccessVoterService'));
            yield 14 => ($container->privates['contao.security.data_container.frontend_module_voter'] ?? $container->load('getContao_Security_DataContainer_FrontendModuleVoterService'));
            yield 15 => ($container->privates['contao.security.data_container.image_size_access_voter'] ?? $container->load('getContao_Security_DataContainer_ImageSizeAccessVoterService'));
            yield 16 => ($container->privates['contao.security.data_container.image_size_item_access_voter'] ?? $container->load('getContao_Security_DataContainer_ImageSizeItemAccessVoterService'));
            yield 17 => ($container->privates['contao.security.data_container.layout_access_voter'] ?? $container->load('getContao_Security_DataContainer_LayoutAccessVoterService'));
            yield 18 => ($container->privates['contao.security.data_container.page_permission_voter'] ?? $container->load('getContao_Security_DataContainer_PagePermissionVoterService'));
            yield 19 => ($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'] ?? $container->load('getPageTypeAccessVoterService'));
            yield 20 => ($container->privates['contao.security.data_container.undo_voter'] ?? $container->load('getContao_Security_DataContainer_UndoVoterService'));
            yield 21 => ($container->privates['contao.security.data_container.user_access_voter'] ?? $container->load('getContao_Security_DataContainer_UserAccessVoterService'));
            yield 22 => ($container->privates['contao.security.member_group_voter'] ??= new \Contao\CoreBundle\Security\Voter\MemberGroupVoter());
            yield 23 => ($container->services['Markocupic\\GalleryCreatorBundle\\Security\\Voter\\AlbumVoter'] ?? $container->load('getAlbumVoterService'));
            yield 24 => ($container->privates['contao_faq.security.faq_access_voter'] ?? $container->load('getContaoFaq_Security_FaqAccessVoterService'));
            yield 25 => ($container->privates['contao_faq.security.faq_category_access_voter'] ?? $container->load('getContaoFaq_Security_FaqCategoryAccessVoterService'));
            yield 26 => ($container->privates['contao_news.security.news_access_voter'] ?? $container->load('getContaoNews_Security_NewsAccessVoterService'));
            yield 27 => ($container->privates['contao_news.security.news_archive_access_voter'] ?? $container->load('getContaoNews_Security_NewsArchiveAccessVoterService'));
            yield 28 => ($container->privates['contao_news.security.news_content_voter'] ?? $container->load('getContaoNews_Security_NewsContentVoterService'));
            yield 29 => ($container->privates['contao_calendar.security.calendar_access_voter'] ?? $container->load('getContaoCalendar_Security_CalendarAccessVoterService'));
            yield 30 => ($container->privates['contao_calendar.security.calendar_content_voter'] ?? $container->load('getContaoCalendar_Security_CalendarContentVoterService'));
            yield 31 => ($container->privates['contao_calendar.security.calendar_events_access_voter'] ?? $container->load('getContaoCalendar_Security_CalendarEventsAccessVoterService'));
            yield 32 => ($container->privates['contao_newsletter.security.newsletter_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterAccessVoterService'));
            yield 33 => ($container->privates['contao_newsletter.security.newsletter_channel_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterChannelAccessVoterService'));
            yield 34 => ($container->privates['contao_newsletter.security.newsletter_recipients_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterRecipientsAccessVoterService'));
            yield 35 => ($container->privates['Codefog\\NewsCategoriesBundle\\Security\\Voter\\DataContainer\\NewsCategoriesVoter'] ?? $container->load('getNewsCategoriesVoterService'));
            yield 36 => ($container->privates['contao.security.default_data_container_voter'] ??= new \Contao\CoreBundle\Security\Voter\DataContainer\DefaultDataContainerVoter());
