...
$catalogue = new MessageCatalogue('de', array (
  ...
  'messages' => 
  array (
    'huh.multicolumneditor.add.default' => 'Hinzufügen',
    'huh.multicolumneditor.delete.default' => 'Entfernen',
    'huh.multicolumneditor.sort.default' => 'Sortieren',
    'bugbuster.dlstat.export.title' => 'Statistik Export',
    'bugbuster.dlstat.export.form.labels.year' => 'Jahr:',
    'bugbuster.dlstat.export.form.labels.month' => 'Monat:',
    'bugbuster.dlstat.export.form.labels.format' => 'Format:',
    'bugbuster.dlstat.export.form.labels.all' => 'Alle',
    'bugbuster.dlstat.export.form.labels.1' => '1',
    'bugbuster.dlstat.export.form.labels.2' => '2',
    'bugbuster.dlstat.export.form.labels.3' => '3',
    'bugbuster.dlstat.export.form.labels.4' => '4',
    'bugbuster.dlstat.export.form.labels.5' => '5',
    'bugbuster.dlstat.export.form.labels.6' => '6',
    'bugbuster.dlstat.export.form.labels.7' => '7',
    'bugbuster.dlstat.export.form.labels.8' => '8',
    'bugbuster.dlstat.export.form.labels.9' => '9',
    'bugbuster.dlstat.export.form.labels.10' => '10',
    'bugbuster.dlstat.export.form.labels.11' => '11',
    'bugbuster.dlstat.export.form.labels.12' => '12',
    'bugbuster.dlstat.export.form.buttons.export' => 'Export',
    'bugbuster.dlstat.export.sheet.header.browser_lang' => 'Browser-Sprache',
    'bugbuster.dlstat.export.sheet.header.date' => 'Datum',
    'bugbuster.dlstat.export.sheet.header.domain' => 'Domain',
    'bugbuster.dlstat.export.sheet.header.filename' => 'Dateiname',
    'bugbuster.dlstat.export.sheet.header.ip' => 'IP',
    'bugbuster.dlstat.export.sheet.header.page_alias' => 'Seiten-Alias',
    'bugbuster.dlstat.export.sheet.header.page_host' => 'Host-Name',
    'bugbuster.dlstat.export.sheet.header.username' => 'Nutzername',
  ),
  'im_contao_event_registration' => 
  array (
    'cannot_register' => 'Die Registrierung zu diesem Event ist nicht mehr möglich.',
    'reg_uuid' => 'UUID',
    'reg_eventid' => 'Event ID',
    'reg_eventtitle' => 'Event Titel',
    'reg_amount' => 'Personenanzahl',
    'reg_confirmed' => 'Registrierung bestätigt',
    'reg_cancelled' => 'Registrierung storniert',
    'export' => 'Export',
    'event_registration_export' => 'Export der Registrierungen für "event"',
    'delimiter_comma' => '<code>,</code> (Komma)',
    'delimiter_semi' => '<code>;</code> (Semikolon)',
    'already_confirmed' => 'Diese Registrierung wurde bereits bestätigt.',
    'already_cancelled' => 'Diese Registrierung wurde bereits storniert.',
    'cannot_confirm' => 'Registrierungen für dieses Event können nicht mehr bestätigt werden.',
    'cannot_cancel' => 'Anmeldungen für dieses Event können nicht mehr storniert werden.',
    'header_count_title' => 'Anmeldungen',
    'header_waiting_title' => 'Warteliste',
    'is_waiting_list' => 'Registrierungen zu diesem Event sind nur mehr mit Warteliste möglich.',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'huh.multicolumneditor.add.default' => 'Add',
    'huh.multicolumneditor.delete.default' => 'Remove',
    'huh.multicolumneditor.sort.default' => 'Sort',
    'bugbuster.dlstat.export.title' => 'Statistics export',
    'bugbuster.dlstat.export.form.labels.year' => 'Year:',
    'bugbuster.dlstat.export.form.labels.month' => 'Month:',
    'bugbuster.dlstat.export.form.labels.format' => 'Format:',
    'bugbuster.dlstat.export.form.labels.all' => 'All',
    'bugbuster.dlstat.export.form.labels.1' => '1',
    'bugbuster.dlstat.export.form.labels.2' => '2',
    'bugbuster.dlstat.export.form.labels.3' => '3',
    'bugbuster.dlstat.export.form.labels.4' => '4',
    ...
    'bugbuster.dlstat.export.form.labels.12' => '12',
    'bugbuster.dlstat.export.form.buttons.export' => 'Export',
    'bugbuster.dlstat.export.sheet.header.browser_lang' => 'Browser Language',
    'bugbuster.dlstat.export.sheet.header.date' => 'Date',
    'bugbuster.dlstat.export.sheet.header.domain' => 'Domain',
    'bugbuster.dlstat.export.sheet.header.filename' => 'Filename',
    'bugbuster.dlstat.export.sheet.header.ip' => 'IP',
    'bugbuster.dlstat.export.sheet.header.page_alias' => 'Page Alias',
    'bugbuster.dlstat.export.sheet.header.page_host' => 'Page Host',
    'bugbuster.dlstat.export.sheet.header.username' => 'Username',
  ),
  'im_contao_event_registration' => 
  array (
    'cannot_register' => 'Registration to this event is currently not possible.',
    'reg_uuid' => 'UUID',
    'reg_eventid' => 'Event ID',
    'reg_eventtitle' => 'Event title',
    'reg_amount' => 'Amount of people',
    'reg_confirmed' => 'Registration confirmed',
    'reg_cancelled' => 'Registration cancelled',
    'export' => 'Export',
    'event_registration_export' => 'Event registration export for "event"',
    'delimiter_comma' => '<code>,</code> (Comma)',
    'delimiter_semi' => '<code>;</code> (Semicolon)',
    'already_confirmed' => 'This event registration has already been confirmed.',
    'already_cancelled' => 'This event registration has already been cancelled.',
    'cannot_confirm' => 'Registrations for this event cannot be confirmed anymore.',
    'cannot_cancel' => 'Registrations for this event cannot be cancelled anymore.',
    'header_count_title' => 'Registrations',
    'header_waiting_title' => 'Waiting list',
