...
class getServicesResetterService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['monolog.handler.visitors'])) {
                yield 'monolog.handler.visitors' => ($container->privates['monolog.handler.visitors'] ?? null);
            }
            ...
            if (isset($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'])) {
                yield 'contao.security.data_container.page_type_access_voter' => ($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'] ?? null);
            }
            ...
            if (isset($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'])) {
                yield 'Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter' => ($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'] ?? null);
            }
            ...
            if (isset($container->services['InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener'])) {
                yield 'InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener' => ($container->services['InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener'] ?? null);
            }
            ...
            if (isset($container->services['Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener'])) {
                yield 'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener' => ($container->services['Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener'] ?? null);
            }
            if (isset($container->services['Codefog\\NewsCategoriesBundle\\NewsCategoriesManager'])) {
                yield 'Codefog\\NewsCategoriesBundle\\NewsCategoriesManager' => ($container->services['Codefog\\NewsCategoriesBundle\\NewsCategoriesManager'] ?? null);
            }
            if (isset($container->privates['Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter'])) {
                yield 'Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter' => ($container->privates['Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter'] ?? null);
            }
        ...
        }, fn () => 0 + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['doctrine.debug_data_holder'])) + (int) (isset($container->privates['form.type.entity'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['cache.messenger.restart_workers_signal'])) + (int) (isset($container->privates['http_client.transport'])) + (int) (isset($container->privates['mailer.message_logger_listener'])) + (int) (isset($container->privates['translation.locale_switcher'])) + (int) (isset($container->services['debug.stopwatch'])) + (int) (isset($container->services['event_dispatcher'])) + (int) (isset($container->privates['debug.log_processor'])) + (int) (isset($container->services['cache.rate_limiter'])) + (int) (isset($container->privates['doctrine.result_cache_pool'])) + (int) (isset($container->privates['doctrine.system_cache_pool'])) + (int) (isset($container->privates['session_listener'])) + (int) (isset($container->privates['form.choice_list_factory.cached'])) + (int) (isset($container->services['cache.validator_expression_language'])) + (int) (isset($container->privates['messenger.transport.in_memory.factory'])) + (int) (isset($container->services['.container.private.profiler'])) + (int) (isset($container->privates['debug.validator'])) + (int) (isset($container->privates['monolog.handler.visitors'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.console'])) + (int) (isset($container->privates['monolog.handler.console_very_verbose'])) + (int) (isset($container->services['twig'])) + (int) (isset($container->privates['twig.form.engine'])) + (int) (isset($container->services['security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (isset($container->services['cache.security_is_granted_attribute_expression_language'])) + (int) (isset($container->privates['debug.security.firewall'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.contao_backend'])) + (int) (isset($container->privates['cache.security_token_verifier'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.contao_frontend'])) + (int) (isset($container->services['contao.listener.data_container.content_element_type'])) + (int) (isset($container->services['contao.listener.data_container.cte_alias'])) + (int) (isset($container->services['contao.listener.data_container.layout_options'])) + (int) (isset($container->privates['contao.listener.merge_http_headers'])) + (int) (isset($container->privates['contao.listener.subrequest_cache'])) + (int) (isset($container->services['contao.csrf.token_manager'])) + (int) (isset($container->privates['contao.csrf.token_storage'])) + (int) (isset($container->privates['contao.data_collector'])) + (int) (isset($container->services['contao.framework'])) + (int) (isset($container->services['contao.image.sizes'])) + (int) (isset($container->services['contao.insert_tag.parser'])) + (int) (isset($container->privates['contao.monolog.handler'])) + (int) (isset($container->privates['contao.process_util'])) + (int) (isset($container->services['contao.routing.content_url_generator'])) + (int) (isset($container->services['contao.routing.page_registry'])) + (int) (isset($container->privates['contao.security.backend_access_voter'])) + (int) (isset($container->privates['contao.security.data_container.article_content_voter'])) + (int) (isset($container->privates['contao.security.data_container.content_element_nesting_voter'])) + (int) (isset($container->privates['contao.security.data_container.page_permission_voter'])) + (int) (isset($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'])) + (int) (isset($container->privates['contao.security.data_container.user_access_voter'])) + (int) (isset($container->privates['contao.translation.data_collector_translator'])) + (int) (isset($container->services['contao.twig.filesystem_loader'])) + (int) (isset($container->privates['Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter'])) + (int) (isset($container->services['Codefog\\HasteBundle\\AjaxReloadManager'])) + (int) (isset($container->privates['contao_news.security.news_content_voter'])) + (int) (isset($container->services['InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener'])) + (int) (isset($container->privates['Terminal42\\NotificationCenterBundle\\Config\\ConfigLoader'])) + (int) (isset($container->privates['contao_calendar.security.calendar_content_voter'])) + (int) (isset($container->services['Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener'])) + (int) (isset($container->services['Codefog\\NewsCategoriesBundle\\NewsCategoriesManager'])) + (int) (isset($container->privates['Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter'])) + (int) (isset($container->privates['.debug.http_client'])) + (int) (false) + (int) (false)), ['doctrine' => ['reset'], 'doctrine.debug_data_holder' => ['reset'], 'form.type.entity' => ['reset'], 'cache.app' => ['reset'], 'cache.system' => ['reset'], 'cache.validator' => ['reset'], 'cache.serializer' => ['reset'], 'cache.annotations' => ['reset'], 'cache.property_info' => ['reset'], 'cache.messenger.restart_workers_signal' => ['reset'], 'http_client.transport' => ['?reset'], 'mailer.message_logger_listener' => ['reset'], 'translation.locale_switcher' => ['reset'], 'debug.stopwatch' => ['reset'], 'debug.event_dispatcher' => ['reset'], 'debug.log_processor' => ['reset'], 'cache.rate_limiter' => ['reset'], 'doctrine.result_cache_pool' => ['reset'], 'doctrine.system_cache_pool' => ['reset'], 'session_listener' => ['reset'], 'form.choice_list_factory.cached' => ['reset'], 'cache.validator_expression_language' => ['reset'], 'messenger.transport.in_memory.factory' => ['reset'], 'profiler' => ['reset'], 'debug.validator' => ['reset'], 'monolog.handler.visitors' => ['reset'], 'monolog.handler.main' => ['reset'], 'monolog.handler.console' => ['reset'], 'monolog.handler.console_very_verbose' => ['reset'], 'twig' => ['resetGlobals'], 'twig.form.engine' => ['reset'], 'security.token_storage' => ['disableUsageTracking', 'setToken'], 'cache.security_expression_language' => ['reset'], 'cache.security_is_granted_attribute_expression_language' => ['reset'], 'debug.security.firewall' => ['reset'], 'debug.security.firewall.authenticator.contao_backend' => ['reset'], 'cache.security_token_verifier' => ['reset'], 'debug.security.firewall.authenticator.contao_frontend' => ['reset'], 'contao.listener.data_container.content_element_type' => ['reset'], 'contao.listener.data_container.cte_alias' => ['reset'], 'contao.listener.data_container.layout_options' => ['reset'], 'contao.listener.merge_http_headers' => ['reset'], 'contao.listener.subrequest_cache' => ['reset'], 'contao.csrf.token_manager' => ['reset'], 'contao.csrf.token_storage' => ['reset'], 'contao.data_collector' => ['reset'], 'contao.framework' => ['reset'], 'contao.image.sizes' => ['reset'], 'contao.insert_tag.parser' => ['reset'], 'contao.monolog.handler' => ['reset'], 'contao.process_util' => ['reset'], 'contao.routing.content_url_generator' => ['reset'], 'contao.routing.page_registry' => ['reset'], 'contao.security.backend_access_voter' => ['reset'], 'contao.security.data_container.article_content_voter' => ['reset'], 'contao.security.data_container.content_element_nesting_voter' => ['reset'], 'contao.security.data_container.page_permission_voter' => ['reset'], 'contao.security.data_container.page_type_access_voter' => ['reset'], 'contao.security.data_container.user_access_voter' => ['reset'], 'contao.translation.data_collector_translator' => ['reset'], 'contao.twig.filesystem_loader' => ['reset'], 'Terminal42\\FolderpageBundle\\Voter\\PageTypeAccessVoter' => ['reset'], 'Codefog\\HasteBundle\\AjaxReloadManager' => ['reset'], 'contao_news.security.news_content_voter' => ['reset'], 'InspiredMinds\\ContaoBackendFormsBundle\\EventListener\\ParseWidgetListener' => ['reset'], 'Terminal42\\NotificationCenterBundle\\Config\\ConfigLoader' => ['reset'], 'contao_calendar.security.calendar_content_voter' => ['reset'], 'Codefog\\NewsCategoriesBundle\\EventListener\\DataContainer\\CategoryRootListener' => ['reset'], 'Codefog\\NewsCategoriesBundle\\NewsCategoriesManager' => ['reset'], 'Codefog\\NewsCategoriesBundle\\Security\\Voter\\BackendAccessVoter' => ['reset'], '.debug.http_client' => ['reset'], 'contao.filesystem.dbafs.files' => ['reset'], 'contao.filesystem.dbafs.notification_center_bulky_items_storage' => ['reset']]);
    }
}
