...
$catalogue = new MessageCatalogue('ru', array (
  ...
  'messages' => 
  array (
    'huh.multicolumneditor.add.default' => 'Добавить',
    'huh.multicolumneditor.delete.default' => 'Удалить',
    'huh.multicolumneditor.sort.default' => 'Сортировать по',
    'bugbuster.dlstat.export.title' => 'Экспорт статистики',
    'bugbuster.dlstat.export.form.labels.year' => 'Год:',
    'bugbuster.dlstat.export.form.labels.month' => 'Месяц:',
    'bugbuster.dlstat.export.form.labels.format' => 'Формат:',
    'bugbuster.dlstat.export.form.labels.all' => 'Все',
    ...
    'bugbuster.dlstat.export.form.buttons.export' => 'Экспорт',
    'bugbuster.dlstat.export.sheet.header.browser_lang' => 'Язык браузера',
    'bugbuster.dlstat.export.sheet.header.date' => 'Дата',
    'bugbuster.dlstat.export.sheet.header.domain' => 'Домен',
    'bugbuster.dlstat.export.sheet.header.filename' => 'Имя файла',
    'bugbuster.dlstat.export.sheet.header.ip' => 'IP',
    'bugbuster.dlstat.export.sheet.header.page_alias' => 'Алиас станицы',
    'bugbuster.dlstat.export.sheet.header.page_host' => 'Хост страницы',
    'bugbuster.dlstat.export.sheet.header.username' => 'Имя пользователя',
  ),
));
