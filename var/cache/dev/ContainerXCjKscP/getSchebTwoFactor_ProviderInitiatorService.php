...
class getSchebTwoFactor_ProviderInitiatorService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->privates['scheb_two_factor.provider_registry'] ?? self::getSchebTwoFactor_ProviderRegistryService($container)), new \Scheb\TwoFactorBundle\Security\Authentication\Token\TwoFactorTokenFactory(), new \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\TwoFactorProviderDecider()) && false ?: $lazyLoad);
    }
}
