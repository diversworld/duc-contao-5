...
class __TwigTemplate_33b6259cb4a10cb5ac9b12f68115efec extends Template
{
    ...
    public function block_checkbox_row(array $context, array $blocks = []): iterable
    {
        ...
        if (CoreExtension::inFilter("switch-input", ($context["parent_class"] ?? null))) {
            ...
            yield $this->env->getFilter('escape')->getCallable()($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 9), "id", [], "any", false, false, false, 9), "html", null, true);
            yield "\"></label>";
            // line 10
    ...
    {
        return new Source("", "foundation_6_layout.html.twig", "/shared/httpd/duc-contao-5/vendor/symfony/twig-bridge/Resources/views/Form/foundation_6_layout.html.twig");
    }
}
