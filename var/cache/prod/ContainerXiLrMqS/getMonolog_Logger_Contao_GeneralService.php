...
class getMonolog_Logger_Contao_GeneralService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['monolog.logger.contao.general'])) {
            return $container->services['monolog.logger.contao.general'];
        }
        $b = new \Monolog\Logger('contao.general');
        ...
        return $container->services['monolog.logger.contao.general'] = new \Contao\CoreBundle\Monolog\SystemLogger($b, 'GENERAL');
    }
}
