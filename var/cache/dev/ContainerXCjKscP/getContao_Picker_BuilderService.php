...
class getContao_Picker_BuilderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/terminal42/contao-node/src/Picker/NodePickerProvider.php';
        ...
        $instance->addProvider(new \Terminal42\NodeBundle\Picker\NodePickerProvider($a, $b, $c));
