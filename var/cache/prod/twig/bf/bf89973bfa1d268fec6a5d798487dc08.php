...
class __TwigTemplate_6988aca083a357148136f88275bdf7ec extends Template
{
...
<form class=\"form\" action=\"";
        // line 23
        yield ((($context["checkPathUrl"] ?? null)) ? ($this->env->getFilter('escape')->getCallable()($this->env, ($context["checkPathUrl"] ?? null), "html", null, true)) : ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(($context["checkPathRoute"] ?? null))));
        yield "\" method=\"post\">
    <p class=\"widget\">
        <input
            id=\"_auth_code\"
    ...
    ";
        ...
        if (($context["isCsrfProtectionEnabled"] ?? null)) {
            ...
            yield "\" value=\"";
            yield $this->env->getFilter('escape')->getCallable()($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(($context["csrfTokenId"] ?? null)), "html", null, true);
            yield "\">
    ";
        }
        // line 46
...
";
    ...
    {
        return new Source("", "@SchebTwoFactor/Authentication/form.html.twig", "/shared/httpd/duc-contao-5/vendor/scheb/2fa-bundle/Resources/views/Authentication/form.html.twig");
    }
}
