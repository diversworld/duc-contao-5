...
class getContao_Fragment_CompositorService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add('contao.content_element.cookiebar_opener', false);
        $instance->add('contao.content_element.gallery_creator', false);
        $instance->add('contao.content_element.gallery_creator_news', false);
