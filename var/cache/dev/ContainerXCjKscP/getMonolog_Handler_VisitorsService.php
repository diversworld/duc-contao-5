 ...
 */
class getMonolog_Handler_VisitorsService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['monolog.handler.visitors'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/logs/dev.log'), 0, 'DEBUG', true, NULL, false);
