...
// vendor/oveleon/contao-cookiebar/contao/languages/sv/tl_page.xlf
$GLOBALS['TL_LANG']['tl_page']['cookiebar_legend'] = 'Cookiebox';
$GLOBALS['TL_LANG']['tl_page']['activateCookiebar']['0'] = 'Aktivera cookiebox';
$GLOBALS['TL_LANG']['tl_page']['activateCookiebar']['1'] = 'Aktivera cookieboxen för denna och dess undersidor.';
$GLOBALS['TL_LANG']['tl_page']['triggerCookiebar']['0'] = 'Öppna cookiebox';
$GLOBALS['TL_LANG']['tl_page']['triggerCookiebar']['1'] = 'Här kan du ange om sidan ska användas som en utlösande faktor för att öppna cookieboxen. Om den här sidan ingår i en navigering kommer klickningen inte att vidarebefordras, utan endast cookieboxen kommer att öppnas (om JavaScript är aktivt). Detta är till exempel användbart för enskilda navigationer som placeras i sidfoten på webbplatsen.';
$GLOBALS['TL_LANG']['tl_page']['prefillCookies']['0'] = 'Prefill-Inställningar';
$GLOBALS['TL_LANG']['tl_page']['prefillCookies']['1'] = 'Aktiverar de redan valda cookies när cookieboxen öppnas.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarConfig']['0'] = 'Cookiebox-konfiguration';
$GLOBALS['TL_LANG']['tl_page']['cookiebarConfig']['1'] = 'Välj den cookiebox-konfigurationen som ska användas.';
$GLOBALS['TL_LANG']['tl_page']['overwriteCookiebarMeta']['0'] = 'Skriv över metadata';
$GLOBALS['TL_LANG']['tl_page']['overwriteCookiebarMeta']['1'] = 'Skriv över metainformationen som är lagrad i konfigurationen.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarDescription']['0'] = 'Titel & beskrivning';
$GLOBALS['TL_LANG']['tl_page']['cookiebarDescription']['1'] = 'Beskriv syftet med cookieboxen här.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarInfoDescription']['0'] = 'Ytterligare information';
$GLOBALS['TL_LANG']['tl_page']['cookiebarInfoDescription']['1'] = 'Definiera ytterligare information här, som visas under knapparna.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarAlignment']['0'] = 'Justering';
$GLOBALS['TL_LANG']['tl_page']['cookiebarAlignment']['1'] = 'Definiera här var cookieboxen ska visas.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarBlocking']['0'] = 'Blockering';
$GLOBALS['TL_LANG']['tl_page']['cookiebarBlocking']['1'] = 'Blockerar användningen av webbplatsen tills cookiesboxen har använts.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarHideOnInit']['0'] = 'Dölj cookiebar';
$GLOBALS['TL_LANG']['tl_page']['cookiebarHideOnInit']['1'] = 'Visa inte cookieboxen vid första besöket på sidan. Cookieboxen kan fortfarande öppnas med hjälp av öppnaren för cookieboxen.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarInfoUrls']['0'] = 'Info-Länkar';
$GLOBALS['TL_LANG']['tl_page']['cookiebarInfoUrls']['1'] = 'Ange ytterligare länkar här, t.ex. till dataskyddsdeklarationen, impressum eller juridisk information.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarExcludePages']['0'] = 'Uteslut sidor';
$GLOBALS['TL_LANG']['tl_page']['cookiebarExcludePages']['1'] = 'Definiera de sidor där cookieboxen inte ska öppnas automatiskt.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarButtonColorScheme']['0'] = 'Knappens färgschema';
$GLOBALS['TL_LANG']['tl_page']['cookiebarButtonColorScheme']['1'] = 'Definierar färgschemat för de tillgängliga knapparna.';
$GLOBALS['TL_LANG']['tl_page']['cookiebarTemplate']['0'] = 'Template';
$GLOBALS['TL_LANG']['tl_page']['cookiebarTemplate']['1'] = 'Välj en template.';
