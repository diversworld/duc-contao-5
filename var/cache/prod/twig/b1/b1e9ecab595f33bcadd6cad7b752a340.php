...
class __TwigTemplate_8621ea14f456eaa75176bcaffdb98dec extends Template
{
...
($context["define_proportions"] ?? null)) ? (CoreExtension::getAttribute($this->env, $this->source, $context["source"], "height", [], "any", false, false, false, 90)) : (null))];
    ...
    public function macro_img($figure = null, $options = [], ...$varargs): string|Markup
    {
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            // line 106
            $context["img_attributes"] = Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "options", [], "any", false, true, false, 106), "img_attr", [], "any", true, true, false, 106)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "options", [], "any", false, true, false, 106), "img_attr", [], "any", false, false, false, 106), [])) : ([])), ((CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "img_attr", [], "any", true, true, false, 106)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "img_attr", [], "any", false, false, false, 106), [])) : ([])));
            // line 107
            yield "
    ";
            // line 108
...
($context["img"] ?? null), "src", [], "any", false, false, false, 112), "alt" => ((CoreExtension::getAttribute($this->env, $this->source,             // line 113
($context["figure"] ?? null), "hasMetadata", [], "any", false, false, false, 113)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "metadata", [], "any", false, false, false, 113), "alt", [], "any", false, false, false, 113)) : ("")), "title" => ((CoreExtension::getAttribute($this->env, $this->source,             // line 114
($context["figure"] ?? null), "hasMetadata", [], "any", false, false, false, 114)) ? (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "metadata", [], "any", false, false, false, 114), "title", [], "any", false, false, false, 114)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "metadata", [], "any", false, false, false, 114), "title", [], "any", false, false, false, 114)) : (null))) : (null)), "srcset" => (((CoreExtension::getAttribute($this->env, $this->source,             // line 115
...
($context["img"] ?? null), "sizes", [], "any", true, true, false, 116)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["img"] ?? null), "sizes", [], "any", false, false, false, 116), null)) : (null)), "width" => ((            // line 117
($context["define_proportions"] ?? null)) ? (CoreExtension::getAttribute($this->env, $this->source, ($context["img"] ?? null), "width", [], "any", false, false, false, 117)) : (null)), "height" => ((            // line 118
($context["define_proportions"] ?? null)) ? (CoreExtension::getAttribute($this->env, $this->source, ($context["img"] ?? null), "height", [], "any", false, false, false, 118)) : (null)), "loading" => ((CoreExtension::getAttribute($this->env, $this->source,             // line 119
...
($context["img"] ?? null), "class", [], "any", true, true, false, 120)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["img"] ?? null), "class", [], "any", false, false, false, 120), null)) : (null))];
    ...
    public function macro_caption($figure = null, $options = [], ...$varargs): string|Markup
    {
        ...
        return ('' === $tmp = \Twig\Extension\CoreExtension::captureOutput((function () use (&$context, $macros, $blocks) {
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "hasMetadata", [], "any", false, false, false, 131) && CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "metadata", [], "any", false, false, false, 131), "caption", [], "any", false, false, false, 131))) {
                // line 132
                yield "        ";
                $context["caption_attributes"] = Twig\Extension\CoreExtension::merge(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "options", [], "any", false, true, false, 132), "caption_attr", [], "any", true, true, false, 132)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["figure"] ?? null), "options", [], "any", false, true, false, 132), "caption_attr", [], "any", false, false, false, 132), [])) : ([])), ((CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "caption_attr", [], "any", true, true, false, 132)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "caption_attr", [], "any", false, false, false, 132), [])) : ([])));
                // line 133
                yield "        <figcaption";
    ...
    {
        return new Source("", "@ContaoCore/Image/Studio/_macros.html.twig", "/shared/httpd/duc-contao-5/vendor/contao/core-bundle/templates/Image/Studio/_macros.html.twig");
    }
}
