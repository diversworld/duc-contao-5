 ...
 */
class getEventRegistrationFormControllerService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    /**
     * Gets the public 'InspiredMinds\ContaoEventRegistration\Controller\FrontendModule\EventRegistrationFormController' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationFormController'] = $instance = new \InspiredMinds\ContaoEventRegistration\Controller\FrontendModule\EventRegistrationFormController(($container->privates['InspiredMinds\\ContaoEventRegistration\\EventRegistration'] ?? $container->load('getEventRegistrationService')));

        $instance->setContainer(($container->privates['.service_locator..72JI_b'] ?? $container->load('get_ServiceLocator__72JIBService'))->withContext('InspiredMinds\\ContaoEventRegistration\\Controller\\FrontendModule\\EventRegistrationFormController', $container));
