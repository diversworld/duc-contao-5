...
class getConsole_CommandLoaderService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'HeimrichHannot\\UtilsBundle\\Command\\EntityFinderCommand' => ['privates', '.HeimrichHannot\\UtilsBundle\\Command\\EntityFinderCommand.lazy', 'getEntityFinderCommand_LazyService', true],
            ...
            'cookiebar.anonymizeip' => ['privates', '.cookiebar.anonymizeip.lazy', 'get_Cookiebar_Anonymizeip_LazyService', true],
            'Oveleon\\ContaoCookiebar\\Command\\AnonymizeIpCommand' => ['privates', '.Oveleon\\ContaoCookiebar\\Command\\AnonymizeIpCommand.lazy', 'getAnonymizeIpCommand_LazyService', true],
            'numero2_proper_filenames.command.clean_files' => ['privates', '.numero2_proper_filenames.command.clean_files.lazy', 'get_Numero2ProperFilenames_Command_CleanFiles_LazyService', true],
        ], [
            'HeimrichHannot\\UtilsBundle\\Command\\EntityFinderCommand' => '?',
