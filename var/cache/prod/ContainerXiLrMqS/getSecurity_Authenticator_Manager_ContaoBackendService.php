...
class getSecurity_Authenticator_Manager_ContaoBackendService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $e = ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container));

        if (isset($container->privates['security.authenticator.manager.contao_backend'])) {
            return $container->privates['security.authenticator.manager.contao_backend'];
        }

        return $container->privates['security.authenticator.manager.contao_backend'] = new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([$a, $b, $c], ($container->services['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), $d, 'contao_backend', $e, true, true, []);
    }
}
