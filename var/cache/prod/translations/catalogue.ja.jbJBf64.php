...
$catalogue = new MessageCatalogue('ja', array (
  ...
  'messages' => 
  array (
    'bugbuster.dlstat.export.title' => '統計をエクスポート',
    'bugbuster.dlstat.export.form.labels.year' => '年:',
    'bugbuster.dlstat.export.form.labels.month' => '月:',
    'bugbuster.dlstat.export.form.labels.format' => '書式:',
    'bugbuster.dlstat.export.form.labels.all' => '全て',
    ...
    'bugbuster.dlstat.export.form.buttons.export' => 'エクスポート',
    'bugbuster.dlstat.export.sheet.header.browser_lang' => 'ブラウザーの言語',
    'bugbuster.dlstat.export.sheet.header.date' => '日付',
    'bugbuster.dlstat.export.sheet.header.domain' => 'ドメイン',
    'bugbuster.dlstat.export.sheet.header.filename' => 'ファイル名',
    'bugbuster.dlstat.export.sheet.header.ip' => 'IP',
    'bugbuster.dlstat.export.sheet.header.page_alias' => 'ページのエイリアス',
    'bugbuster.dlstat.export.sheet.header.page_host' => 'ページのホスト',
    'bugbuster.dlstat.export.sheet.header.username' => 'ユーザー名',
  ),
));
