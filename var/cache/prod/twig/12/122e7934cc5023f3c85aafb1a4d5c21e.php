...
class __TwigTemplate_0a2e7236da4b73e3159b3d63e57b7a27 extends Template
{
    ...
    public function block_form_errors(array $context, array $blocks = []): iterable
    {
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["errors"] ?? null)) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 27
                yield "<li class=\"";
                yield $this->env->getFilter('escape')->getCallable()($this->env, ((array_key_exists("error_item_class", $context)) ? (Twig\Extension\CoreExtension::default(($context["error_item_class"] ?? null), "text-red-700")) : ("text-red-700")), "html", null, true);
                yield "\">";
                yield $this->env->getFilter('escape')->getCallable()($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["error"], "message", [], "any", false, false, false, 27), "html", null, true);
                yield "</li>";
            }
    ...
    {
        return new Source("", "tailwind_2_layout.html.twig", "/shared/httpd/duc-contao-5/vendor/symfony/twig-bridge/Resources/views/Form/tailwind_2_layout.html.twig");
    }
}
