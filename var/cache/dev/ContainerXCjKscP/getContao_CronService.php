...
class getContao_CronService extends Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/terminal42/contao-leads/src/Cron/PurgeCron.php';
        ...
        include_once \dirname(__DIR__, 4).'/vendor/markocupic/contao-altcha-antispam/src/Cron/PurgeExpiredChallengesCron.php';
        include_once \dirname(__DIR__, 4).'/vendor/contao/newsletter-bundle/src/Cron/PurgeSubscriptionsCron.php';
        include_once \dirname(__DIR__, 4).'/vendor/cgoit/contao-leads-optin-bundle/src/Cron/PurgeCron.php';
        include_once \dirname(__DIR__, 4).'/vendor/inspiredminds/contao-event-registration/src/Cron/WaitingListsCronJob.php';
        ...
        $d = ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem());
        $e = ($container->services['Markocupic\\ImportFromCsvBundle\\Cron\\Cron'] ?? $container->load('getCronService'));
        ...
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \Contao\CoreBundle\Cron\PurgeTempFolderCron($d, \dirname(__DIR__, 4), $c), '@daily', NULL, 'contao.cron.purge_temp_folder'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob($e, '* * * * *', 'initMinutely', 'Markocupic\\ImportFromCsvBundle\\Cron\\Cron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob($e, '@hourly', 'initHourly', 'Markocupic\\ImportFromCsvBundle\\Cron\\Cron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob($e, '@daily', 'initDaily', 'Markocupic\\ImportFromCsvBundle\\Cron\\Cron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob($e, '@weekly', 'initWeekly', 'Markocupic\\ImportFromCsvBundle\\Cron\\Cron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob($e, '@monthly', 'initMonthly', 'Markocupic\\ImportFromCsvBundle\\Cron\\Cron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \Terminal42\LeadsBundle\Cron\PurgeCron($b, $d, $c), '@daily', NULL, 'Terminal42\\LeadsBundle\\Cron\\PurgeCron'));
        ...
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \Markocupic\ContaoAltchaAntispam\Cron\PurgeExpiredChallengesCron($b), '@hourly', NULL, 'Markocupic\\ContaoAltchaAntispam\\Cron\\PurgeExpiredChallengesCron'));
        ...
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \Cgoit\LeadsOptinBundle\Cron\PurgeCron($b, $d, $c), '@daily', NULL, 'Cgoit\\LeadsOptinBundle\\Cron\\PurgeCron'));
        $instance->addCronJob(new \Contao\CoreBundle\Cron\CronJob(new \InspiredMinds\ContaoEventRegistration\Cron\WaitingListsCronJob(($container->privates['InspiredMinds\\ContaoEventRegistration\\WaitingListChecker'] ?? $container->load('getWaitingListCheckerService'))), '@hourly', NULL, 'InspiredMinds\\ContaoEventRegistration\\Cron\\WaitingListsCronJob'));
