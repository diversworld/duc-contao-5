...
namespace Diversworld\ContaoCheckBundle\Controller\FrontendModule;
...
#[AsFrontendModule(category: 'check_modules', template: 'mod_check_listing')]
class CheckListingController extends AbstractFrontendModuleController
{
    public const TYPE = 'check_listing';
